[bun-types](https://github.com/oven-sh/bun-types/blob/master/api-docs/README.md) / [Exports](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules.md) / "sys"
...
- [inspect](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.inspect.md)
- [promisify](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.promisify.md)

### Interfaces

- [CustomPromisifyLegacy](https://github.com/oven-sh/bun-types/blob/master/api-docs/interfaces/sys_.CustomPromisifyLegacy.md)
- [CustomPromisifySymbol](https://github.com/oven-sh/bun-types/blob/master/api-docs/interfaces/sys_.CustomPromisifySymbol.md)
- [DebugLogger](https://github.com/oven-sh/bun-types/blob/master/api-docs/interfaces/sys_.DebugLogger.md)
- [EncodeIntoResult](https://github.com/oven-sh/bun-types/blob/master/api-docs/interfaces/sys_.EncodeIntoResult.md)
- [InspectOptions](https://github.com/oven-sh/bun-types/blob/master/api-docs/interfaces/sys_.InspectOptions.md)
- [InspectOptionsStylized](https://github.com/oven-sh/bun-types/blob/master/api-docs/interfaces/sys_.InspectOptionsStylized.md)

### Type Aliases

- [CustomInspectFunction](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#custominspectfunction)
- [CustomPromisify](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#custompromisify)
- [DebugLoggerFunction](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#debugloggerfunction)
- [Style](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#style)

### Functions

- [callbackify](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#callbackify)
- [debug](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#debug)
- [debuglog](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#debuglog)
- [deprecate](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#deprecate)
- [format](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#format)
- [inherits](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#inherits)
- [inspect](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#inspect)
- [isArray](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isarray)
- [isBoolean](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isboolean)
- [isBuffer](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isbuffer)
- [isDate](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isdate)
- [isDeepStrictEqual](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isdeepstrictequal)
- [isError](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#iserror)
- [isFunction](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isfunction)
- [isNull](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isnull)
- [isNullOrUndefined](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isnullorundefined)
- [isNumber](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isnumber)
- [isObject](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isobject)
- [isPrimitive](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isprimitive)
- [isRegExp](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isregexp)
- [isString](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isstring)
- [isSymbol](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#issymbol)
- [isUndefined](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#isundefined)
- [log](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#log)
- [promisify](https://github.com/oven-sh/bun-types/blob/master/api-docs/modules/sys_.md#promisify)
