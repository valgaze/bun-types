[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](stream_.md) / pipeline

# Namespace: pipeline

["stream"](stream_.md).pipeline

## Table of contents

### Functions

- [\_\_promisify\_\_](stream_.pipeline.md#__promisify__)
...
▸ **__promisify__**<`A`, `T1`, `T2`, `T3`, `B`\>(`source`, `transform1`, `transform2`, `transform3`, `destination`, `options?`): [`PipelinePromise`](stream_.md#pipelinepromise)<`B`\>
