[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](crypto_.md) / constants

# Namespace: constants

["crypto"](crypto_.md).constants

## Table of contents

### Variables

- [ALPN\_ENABLED](crypto_.constants.md#alpn_enabled)
- [DH\_CHECK\_P\_NOT\_PRIME](crypto_.constants.md#dh_check_p_not_prime)
- [DH\_CHECK\_P\_NOT\_SAFE\_PRIME](crypto_.constants.md#dh_check_p_not_safe_prime)
- [DH\_NOT\_SUITABLE\_GENERATOR](crypto_.constants.md#dh_not_suitable_generator)
- [DH\_UNABLE\_TO\_CHECK\_GENERATOR](crypto_.constants.md#dh_unable_to_check_generator)
- [ENGINE\_METHOD\_ALL](crypto_.constants.md#engine_method_all)
- [ENGINE\_METHOD\_CIPHERS](crypto_.constants.md#engine_method_ciphers)
- [ENGINE\_METHOD\_DH](crypto_.constants.md#engine_method_dh)
- [ENGINE\_METHOD\_DIGESTS](crypto_.constants.md#engine_method_digests)
- [ENGINE\_METHOD\_DSA](crypto_.constants.md#engine_method_dsa)
- [ENGINE\_METHOD\_EC](crypto_.constants.md#engine_method_ec)
- [ENGINE\_METHOD\_NONE](crypto_.constants.md#engine_method_none)
- [ENGINE\_METHOD\_PKEY\_ASN1\_METHS](crypto_.constants.md#engine_method_pkey_asn1_meths)
- [ENGINE\_METHOD\_PKEY\_METHS](crypto_.constants.md#engine_method_pkey_meths)
- [ENGINE\_METHOD\_RAND](crypto_.constants.md#engine_method_rand)
- [ENGINE\_METHOD\_RSA](crypto_.constants.md#engine_method_rsa)
- [OPENSSL\_VERSION\_NUMBER](crypto_.constants.md#openssl_version_number)
- [POINT\_CONVERSION\_COMPRESSED](crypto_.constants.md#point_conversion_compressed)
- [POINT\_CONVERSION\_HYBRID](crypto_.constants.md#point_conversion_hybrid)
- [POINT\_CONVERSION\_UNCOMPRESSED](crypto_.constants.md#point_conversion_uncompressed)
- [RSA\_NO\_PADDING](crypto_.constants.md#rsa_no_padding)
- [RSA\_PKCS1\_OAEP\_PADDING](crypto_.constants.md#rsa_pkcs1_oaep_padding)
- [RSA\_PKCS1\_PADDING](crypto_.constants.md#rsa_pkcs1_padding)
- [RSA\_PKCS1\_PSS\_PADDING](crypto_.constants.md#rsa_pkcs1_pss_padding)
- [RSA\_PSS\_SALTLEN\_AUTO](crypto_.constants.md#rsa_pss_saltlen_auto)
- [RSA\_PSS\_SALTLEN\_DIGEST](crypto_.constants.md#rsa_pss_saltlen_digest)
- [RSA\_PSS\_SALTLEN\_MAX\_SIGN](crypto_.constants.md#rsa_pss_saltlen_max_sign)
- [RSA\_SSLV23\_PADDING](crypto_.constants.md#rsa_sslv23_padding)
- [RSA\_X931\_PADDING](crypto_.constants.md#rsa_x931_padding)
- [SSL\_OP\_ALL](crypto_.constants.md#ssl_op_all)
- [SSL\_OP\_ALLOW\_UNSAFE\_LEGACY\_RENEGOTIATION](crypto_.constants.md#ssl_op_allow_unsafe_legacy_renegotiation)
- [SSL\_OP\_CIPHER\_SERVER\_PREFERENCE](crypto_.constants.md#ssl_op_cipher_server_preference)
- [SSL\_OP\_CISCO\_ANYCONNECT](crypto_.constants.md#ssl_op_cisco_anyconnect)
- [SSL\_OP\_COOKIE\_EXCHANGE](crypto_.constants.md#ssl_op_cookie_exchange)
- [SSL\_OP\_CRYPTOPRO\_TLSEXT\_BUG](crypto_.constants.md#ssl_op_cryptopro_tlsext_bug)
- [SSL\_OP\_DONT\_INSERT\_EMPTY\_FRAGMENTS](crypto_.constants.md#ssl_op_dont_insert_empty_fragments)
- [SSL\_OP\_EPHEMERAL\_RSA](crypto_.constants.md#ssl_op_ephemeral_rsa)
- [SSL\_OP\_LEGACY\_SERVER\_CONNECT](crypto_.constants.md#ssl_op_legacy_server_connect)
- [SSL\_OP\_MICROSOFT\_BIG\_SSLV3\_BUFFER](crypto_.constants.md#ssl_op_microsoft_big_sslv3_buffer)
- [SSL\_OP\_MICROSOFT\_SESS\_ID\_BUG](crypto_.constants.md#ssl_op_microsoft_sess_id_bug)
- [SSL\_OP\_MSIE\_SSLV2\_RSA\_PADDING](crypto_.constants.md#ssl_op_msie_sslv2_rsa_padding)
- [SSL\_OP\_NETSCAPE\_CA\_DN\_BUG](crypto_.constants.md#ssl_op_netscape_ca_dn_bug)
- [SSL\_OP\_NETSCAPE\_CHALLENGE\_BUG](crypto_.constants.md#ssl_op_netscape_challenge_bug)
- [SSL\_OP\_NETSCAPE\_DEMO\_CIPHER\_CHANGE\_BUG](crypto_.constants.md#ssl_op_netscape_demo_cipher_change_bug)
- [SSL\_OP\_NETSCAPE\_REUSE\_CIPHER\_CHANGE\_BUG](crypto_.constants.md#ssl_op_netscape_reuse_cipher_change_bug)
- [SSL\_OP\_NO\_COMPRESSION](crypto_.constants.md#ssl_op_no_compression)
- [SSL\_OP\_NO\_QUERY\_MTU](crypto_.constants.md#ssl_op_no_query_mtu)
- [SSL\_OP\_NO\_SESSION\_RESUMPTION\_ON\_RENEGOTIATION](crypto_.constants.md#ssl_op_no_session_resumption_on_renegotiation)
- [SSL\_OP\_NO\_SSLv2](crypto_.constants.md#ssl_op_no_sslv2)
- [SSL\_OP\_NO\_SSLv3](crypto_.constants.md#ssl_op_no_sslv3)
- [SSL\_OP\_NO\_TICKET](crypto_.constants.md#ssl_op_no_ticket)
- [SSL\_OP\_NO\_TLSv1](crypto_.constants.md#ssl_op_no_tlsv1)
- [SSL\_OP\_NO\_TLSv1\_1](crypto_.constants.md#ssl_op_no_tlsv1_1)
- [SSL\_OP\_NO\_TLSv1\_2](crypto_.constants.md#ssl_op_no_tlsv1_2)
- [SSL\_OP\_PKCS1\_CHECK\_1](crypto_.constants.md#ssl_op_pkcs1_check_1)
- [SSL\_OP\_PKCS1\_CHECK\_2](crypto_.constants.md#ssl_op_pkcs1_check_2)
- [SSL\_OP\_SINGLE\_DH\_USE](crypto_.constants.md#ssl_op_single_dh_use)
- [SSL\_OP\_SINGLE\_ECDH\_USE](crypto_.constants.md#ssl_op_single_ecdh_use)
- [SSL\_OP\_SSLEAY\_080\_CLIENT\_DH\_BUG](crypto_.constants.md#ssl_op_ssleay_080_client_dh_bug)
- [SSL\_OP\_SSLREF2\_REUSE\_CERT\_TYPE\_BUG](crypto_.constants.md#ssl_op_sslref2_reuse_cert_type_bug)
- [SSL\_OP\_TLS\_BLOCK\_PADDING\_BUG](crypto_.constants.md#ssl_op_tls_block_padding_bug)
- [SSL\_OP\_TLS\_D5\_BUG](crypto_.constants.md#ssl_op_tls_d5_bug)
- [SSL\_OP\_TLS\_ROLLBACK\_BUG](crypto_.constants.md#ssl_op_tls_rollback_bug)
- [defaultCipherList](crypto_.constants.md#defaultcipherlist)
- [defaultCoreCipherList](crypto_.constants.md#defaultcorecipherlist)
