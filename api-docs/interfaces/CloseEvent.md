[bun-types](../README.md) / [Exports](../modules.md) / CloseEvent
...
- [AT\_TARGET](CloseEvent.md#at_target)
- [BUBBLING\_PHASE](CloseEvent.md#bubbling_phase)
- [CAPTURING\_PHASE](CloseEvent.md#capturing_phase)
- [NONE](CloseEvent.md#none)
- [bubbles](CloseEvent.md#bubbles)
- [cancelBubble](CloseEvent.md#cancelbubble)
- [cancelable](CloseEvent.md#cancelable)
- [code](CloseEvent.md#code)
- [composed](CloseEvent.md#composed)
- [currentTarget](CloseEvent.md#currenttarget)
- [defaultPrevented](CloseEvent.md#defaultprevented)
- [eventPhase](CloseEvent.md#eventphase)
- [isTrusted](CloseEvent.md#istrusted)
- [reason](CloseEvent.md#reason)
- [returnValue](CloseEvent.md#returnvalue)
- [srcElement](CloseEvent.md#srcelement)
- [target](CloseEvent.md#target)
- [timeStamp](CloseEvent.md#timestamp)
- [type](CloseEvent.md#type)
- [wasClean](CloseEvent.md#wasclean)

### Methods

- [composedPath](CloseEvent.md#composedpath)
- [initEvent](CloseEvent.md#initevent)
- [preventDefault](CloseEvent.md#preventdefault)
- [stopImmediatePropagation](CloseEvent.md#stopimmediatepropagation)
- [stopPropagation](CloseEvent.md#stoppropagation)
...
[globals.d.ts:1303](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1303)

[dist/types.d.ts:9873](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9873)
...
[globals.d.ts:1305](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1305)

[dist/types.d.ts:9875](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9875)
...
[globals.d.ts:1307](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1307)

[dist/types.d.ts:9877](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9877)
