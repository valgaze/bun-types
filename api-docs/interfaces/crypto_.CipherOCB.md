[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / CipherOCB

# Interface: CipherOCB

["crypto"](../modules/crypto_.md).CipherOCB
...
The [createCipher](../modules/crypto_.md#createcipher) or [createCipheriv](../modules/crypto_.md#createcipheriv) methods are
...
- [allowHalfOpen](crypto_.CipherOCB.md#allowhalfopen)
- [destroyed](crypto_.CipherOCB.md#destroyed)
- [locked](crypto_.CipherOCB.md#locked)
- [readable](crypto_.CipherOCB.md#readable)
- [readableAborted](crypto_.CipherOCB.md#readableaborted)
- [readableEncoding](crypto_.CipherOCB.md#readableencoding)
- [readableEnded](crypto_.CipherOCB.md#readableended)
- [readableFlowing](crypto_.CipherOCB.md#readableflowing)
- [readableHighWaterMark](crypto_.CipherOCB.md#readablehighwatermark)
- [readableLength](crypto_.CipherOCB.md#readablelength)
- [readableObjectMode](crypto_.CipherOCB.md#readableobjectmode)
- [writable](crypto_.CipherOCB.md#writable)
- [writableCorked](crypto_.CipherOCB.md#writablecorked)
- [writableEnded](crypto_.CipherOCB.md#writableended)
- [writableFinished](crypto_.CipherOCB.md#writablefinished)
- [writableHighWaterMark](crypto_.CipherOCB.md#writablehighwatermark)
- [writableLength](crypto_.CipherOCB.md#writablelength)
- [writableObjectMode](crypto_.CipherOCB.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto_.CipherOCB.md#[asynciterator])
- [\_construct](crypto_.CipherOCB.md#_construct)
- [\_destroy](crypto_.CipherOCB.md#_destroy)
- [\_final](crypto_.CipherOCB.md#_final)
- [\_flush](crypto_.CipherOCB.md#_flush)
- [\_read](crypto_.CipherOCB.md#_read)
- [\_transform](crypto_.CipherOCB.md#_transform)
- [\_write](crypto_.CipherOCB.md#_write)
- [\_writev](crypto_.CipherOCB.md#_writev)
- [abort](crypto_.CipherOCB.md#abort)
- [addListener](crypto_.CipherOCB.md#addlistener)
- [cancel](crypto_.CipherOCB.md#cancel)
- [close](crypto_.CipherOCB.md#close)
- [cork](crypto_.CipherOCB.md#cork)
- [destroy](crypto_.CipherOCB.md#destroy)
- [emit](crypto_.CipherOCB.md#emit)
- [end](crypto_.CipherOCB.md#end)
- [eventNames](crypto_.CipherOCB.md#eventnames)
- [final](crypto_.CipherOCB.md#final)
- [forEach](crypto_.CipherOCB.md#foreach)
- [getAuthTag](crypto_.CipherOCB.md#getauthtag)
- [getMaxListeners](crypto_.CipherOCB.md#getmaxlisteners)
- [getReader](crypto_.CipherOCB.md#getreader)
- [getWriter](crypto_.CipherOCB.md#getwriter)
- [isPaused](crypto_.CipherOCB.md#ispaused)
- [listenerCount](crypto_.CipherOCB.md#listenercount)
- [listeners](crypto_.CipherOCB.md#listeners)
- [off](crypto_.CipherOCB.md#off)
- [on](crypto_.CipherOCB.md#on)
- [once](crypto_.CipherOCB.md#once)
- [pause](crypto_.CipherOCB.md#pause)
- [pipe](crypto_.CipherOCB.md#pipe)
- [pipeThrough](crypto_.CipherOCB.md#pipethrough)
- [pipeTo](crypto_.CipherOCB.md#pipeto)
- [prependListener](crypto_.CipherOCB.md#prependlistener)
- [prependOnceListener](crypto_.CipherOCB.md#prependoncelistener)
- [push](crypto_.CipherOCB.md#push)
- [rawListeners](crypto_.CipherOCB.md#rawlisteners)
- [read](crypto_.CipherOCB.md#read)
- [removeAllListeners](crypto_.CipherOCB.md#removealllisteners)
- [removeListener](crypto_.CipherOCB.md#removelistener)
- [resume](crypto_.CipherOCB.md#resume)
- [setAAD](crypto_.CipherOCB.md#setaad)
- [setAutoPadding](crypto_.CipherOCB.md#setautopadding)
- [setDefaultEncoding](crypto_.CipherOCB.md#setdefaultencoding)
- [setEncoding](crypto_.CipherOCB.md#setencoding)
- [setMaxListeners](crypto_.CipherOCB.md#setmaxlisteners)
- [tee](crypto_.CipherOCB.md#tee)
- [uncork](crypto_.CipherOCB.md#uncork)
- [unpipe](crypto_.CipherOCB.md#unpipe)
- [unshift](crypto_.CipherOCB.md#unshift)
- [update](crypto_.CipherOCB.md#update)
- [wrap](crypto_.CipherOCB.md#wrap)
- [write](crypto_.CipherOCB.md#write)
...
The buffered data will be flushed when either the [uncork](crypto_.CipherOCB.md#uncork) or [end](crypto_.CipherOCB.md#end) methods are called.
...
Calling the [write](crypto_.CipherOCB.md#write) method after calling [end](crypto_.CipherOCB.md#end) will raise an error.
...
Calling [read](crypto_.CipherOCB.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.CipherOCB.md#cork) was called.
...
using the [pipe](crypto_.CipherOCB.md#pipe) method.
...
Unlike [push](crypto_.CipherOCB.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.CipherOCB.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.CipherOCB.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.CipherOCB.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.CipherOCB.md#pipe). However, if calling `write()` is preferred, it is
