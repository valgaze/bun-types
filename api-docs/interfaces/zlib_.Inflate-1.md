[bun-types](../README.md) / [Exports](../modules.md) / ["zlib"](../modules/zlib_.md) / Inflate

# Interface: Inflate

["zlib"](../modules/zlib_.md).Inflate
...
- [allowHalfOpen](zlib_.Inflate-1.md#allowhalfopen)
- [bytesRead](zlib_.Inflate-1.md#bytesread)
- [bytesWritten](zlib_.Inflate-1.md#byteswritten)
- [destroyed](zlib_.Inflate-1.md#destroyed)
- [locked](zlib_.Inflate-1.md#locked)
- [readable](zlib_.Inflate-1.md#readable)
- [readableAborted](zlib_.Inflate-1.md#readableaborted)
- [readableEncoding](zlib_.Inflate-1.md#readableencoding)
- [readableEnded](zlib_.Inflate-1.md#readableended)
- [readableFlowing](zlib_.Inflate-1.md#readableflowing)
- [readableHighWaterMark](zlib_.Inflate-1.md#readablehighwatermark)
- [readableLength](zlib_.Inflate-1.md#readablelength)
- [readableObjectMode](zlib_.Inflate-1.md#readableobjectmode)
- [shell](zlib_.Inflate-1.md#shell)
- [writable](zlib_.Inflate-1.md#writable)
- [writableCorked](zlib_.Inflate-1.md#writablecorked)
- [writableEnded](zlib_.Inflate-1.md#writableended)
- [writableFinished](zlib_.Inflate-1.md#writablefinished)
- [writableHighWaterMark](zlib_.Inflate-1.md#writablehighwatermark)
- [writableLength](zlib_.Inflate-1.md#writablelength)
- [writableObjectMode](zlib_.Inflate-1.md#writableobjectmode)

### Methods

- [[asyncIterator]](zlib_.Inflate-1.md#[asynciterator])
- [\_construct](zlib_.Inflate-1.md#_construct)
- [\_destroy](zlib_.Inflate-1.md#_destroy)
- [\_final](zlib_.Inflate-1.md#_final)
- [\_flush](zlib_.Inflate-1.md#_flush)
- [\_read](zlib_.Inflate-1.md#_read)
- [\_transform](zlib_.Inflate-1.md#_transform)
- [\_write](zlib_.Inflate-1.md#_write)
- [\_writev](zlib_.Inflate-1.md#_writev)
- [abort](zlib_.Inflate-1.md#abort)
- [addListener](zlib_.Inflate-1.md#addlistener)
- [cancel](zlib_.Inflate-1.md#cancel)
- [close](zlib_.Inflate-1.md#close)
- [cork](zlib_.Inflate-1.md#cork)
- [destroy](zlib_.Inflate-1.md#destroy)
- [emit](zlib_.Inflate-1.md#emit)
- [end](zlib_.Inflate-1.md#end)
- [eventNames](zlib_.Inflate-1.md#eventnames)
- [flush](zlib_.Inflate-1.md#flush)
- [forEach](zlib_.Inflate-1.md#foreach)
- [getMaxListeners](zlib_.Inflate-1.md#getmaxlisteners)
- [getReader](zlib_.Inflate-1.md#getreader)
- [getWriter](zlib_.Inflate-1.md#getwriter)
- [isPaused](zlib_.Inflate-1.md#ispaused)
- [listenerCount](zlib_.Inflate-1.md#listenercount)
- [listeners](zlib_.Inflate-1.md#listeners)
- [off](zlib_.Inflate-1.md#off)
- [on](zlib_.Inflate-1.md#on)
- [once](zlib_.Inflate-1.md#once)
- [pause](zlib_.Inflate-1.md#pause)
- [pipe](zlib_.Inflate-1.md#pipe)
- [pipeThrough](zlib_.Inflate-1.md#pipethrough)
- [pipeTo](zlib_.Inflate-1.md#pipeto)
- [prependListener](zlib_.Inflate-1.md#prependlistener)
- [prependOnceListener](zlib_.Inflate-1.md#prependoncelistener)
- [push](zlib_.Inflate-1.md#push)
- [rawListeners](zlib_.Inflate-1.md#rawlisteners)
- [read](zlib_.Inflate-1.md#read)
- [removeAllListeners](zlib_.Inflate-1.md#removealllisteners)
- [removeListener](zlib_.Inflate-1.md#removelistener)
- [reset](zlib_.Inflate-1.md#reset)
- [resume](zlib_.Inflate-1.md#resume)
- [setDefaultEncoding](zlib_.Inflate-1.md#setdefaultencoding)
- [setEncoding](zlib_.Inflate-1.md#setencoding)
- [setMaxListeners](zlib_.Inflate-1.md#setmaxlisteners)
- [tee](zlib_.Inflate-1.md#tee)
- [uncork](zlib_.Inflate-1.md#uncork)
- [unpipe](zlib_.Inflate-1.md#unpipe)
- [unshift](zlib_.Inflate-1.md#unshift)
- [wrap](zlib_.Inflate-1.md#wrap)
- [write](zlib_.Inflate-1.md#write)
...
The buffered data will be flushed when either the [uncork](zlib_.Inflate-1.md#uncork) or [end](zlib_.Inflate-1.md#end) methods are called.
...
Calling the [write](zlib_.Inflate-1.md#write) method after calling [end](zlib_.Inflate-1.md#end) will raise an error.
...
Calling [read](zlib_.Inflate-1.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](zlib_.Inflate-1.md#cork) was called.
...
using the [pipe](zlib_.Inflate-1.md#pipe) method.
...
Unlike [push](zlib_.Inflate-1.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](zlib_.Inflate-1.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](zlib_.Inflate-1.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](zlib_.Inflate-1.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](zlib_.Inflate-1.md#pipe). However, if calling `write()` is preferred, it is
