[bun-types](../README.md) / [Exports](../modules.md) / ["zlib"](../modules/zlib_.md) / Deflate
...
Calling the [write](zlib_.Deflate-1.md#write) method after calling [end](zlib_.Deflate-1.md#end) will raise an error.
