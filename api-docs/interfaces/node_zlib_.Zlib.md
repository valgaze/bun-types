[bun-types](../README.md) / [Exports](../modules.md) / ["node:zlib"](../modules/node_zlib_.md) / Zlib

# Interface: Zlib

["node:zlib"](../modules/node_zlib_.md).Zlib

## Table of contents

### Properties

- [bytesRead](node_zlib_.Zlib.md#bytesread)
- [bytesWritten](node_zlib_.Zlib.md#byteswritten)
- [shell](node_zlib_.Zlib.md#shell)

### Methods

- [flush](node_zlib_.Zlib.md#flush)
