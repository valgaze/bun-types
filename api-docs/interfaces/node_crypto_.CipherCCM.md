[bun-types](../README.md) / [Exports](../modules.md) / ["node:crypto"](../modules/node_crypto_.md) / CipherCCM

# Interface: CipherCCM

["node:crypto"](../modules/node_crypto_.md).CipherCCM
...
- [allowHalfOpen](node_crypto_.CipherCCM.md#allowhalfopen)
- [destroyed](node_crypto_.CipherCCM.md#destroyed)
- [locked](node_crypto_.CipherCCM.md#locked)
- [readable](node_crypto_.CipherCCM.md#readable)
- [readableAborted](node_crypto_.CipherCCM.md#readableaborted)
- [readableEncoding](node_crypto_.CipherCCM.md#readableencoding)
- [readableEnded](node_crypto_.CipherCCM.md#readableended)
- [readableFlowing](node_crypto_.CipherCCM.md#readableflowing)
- [readableHighWaterMark](node_crypto_.CipherCCM.md#readablehighwatermark)
- [readableLength](node_crypto_.CipherCCM.md#readablelength)
- [readableObjectMode](node_crypto_.CipherCCM.md#readableobjectmode)
- [writable](node_crypto_.CipherCCM.md#writable)
- [writableCorked](node_crypto_.CipherCCM.md#writablecorked)
- [writableEnded](node_crypto_.CipherCCM.md#writableended)
- [writableFinished](node_crypto_.CipherCCM.md#writablefinished)
- [writableHighWaterMark](node_crypto_.CipherCCM.md#writablehighwatermark)
- [writableLength](node_crypto_.CipherCCM.md#writablelength)
- [writableObjectMode](node_crypto_.CipherCCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](node_crypto_.CipherCCM.md#[asynciterator])
- [\_construct](node_crypto_.CipherCCM.md#_construct)
- [\_destroy](node_crypto_.CipherCCM.md#_destroy)
- [\_final](node_crypto_.CipherCCM.md#_final)
- [\_flush](node_crypto_.CipherCCM.md#_flush)
- [\_read](node_crypto_.CipherCCM.md#_read)
- [\_transform](node_crypto_.CipherCCM.md#_transform)
- [\_write](node_crypto_.CipherCCM.md#_write)
- [\_writev](node_crypto_.CipherCCM.md#_writev)
- [abort](node_crypto_.CipherCCM.md#abort)
- [addListener](node_crypto_.CipherCCM.md#addlistener)
- [cancel](node_crypto_.CipherCCM.md#cancel)
- [close](node_crypto_.CipherCCM.md#close)
- [cork](node_crypto_.CipherCCM.md#cork)
- [destroy](node_crypto_.CipherCCM.md#destroy)
- [emit](node_crypto_.CipherCCM.md#emit)
- [end](node_crypto_.CipherCCM.md#end)
- [eventNames](node_crypto_.CipherCCM.md#eventnames)
- [final](node_crypto_.CipherCCM.md#final)
- [forEach](node_crypto_.CipherCCM.md#foreach)
- [getAuthTag](node_crypto_.CipherCCM.md#getauthtag)
- [getMaxListeners](node_crypto_.CipherCCM.md#getmaxlisteners)
- [getReader](node_crypto_.CipherCCM.md#getreader)
- [getWriter](node_crypto_.CipherCCM.md#getwriter)
- [isPaused](node_crypto_.CipherCCM.md#ispaused)
- [listenerCount](node_crypto_.CipherCCM.md#listenercount)
- [listeners](node_crypto_.CipherCCM.md#listeners)
- [off](node_crypto_.CipherCCM.md#off)
- [on](node_crypto_.CipherCCM.md#on)
- [once](node_crypto_.CipherCCM.md#once)
- [pause](node_crypto_.CipherCCM.md#pause)
- [pipe](node_crypto_.CipherCCM.md#pipe)
- [pipeThrough](node_crypto_.CipherCCM.md#pipethrough)
- [pipeTo](node_crypto_.CipherCCM.md#pipeto)
- [prependListener](node_crypto_.CipherCCM.md#prependlistener)
- [prependOnceListener](node_crypto_.CipherCCM.md#prependoncelistener)
- [push](node_crypto_.CipherCCM.md#push)
- [rawListeners](node_crypto_.CipherCCM.md#rawlisteners)
- [read](node_crypto_.CipherCCM.md#read)
- [removeAllListeners](node_crypto_.CipherCCM.md#removealllisteners)
- [removeListener](node_crypto_.CipherCCM.md#removelistener)
- [resume](node_crypto_.CipherCCM.md#resume)
- [setAAD](node_crypto_.CipherCCM.md#setaad)
- [setAutoPadding](node_crypto_.CipherCCM.md#setautopadding)
- [setDefaultEncoding](node_crypto_.CipherCCM.md#setdefaultencoding)
- [setEncoding](node_crypto_.CipherCCM.md#setencoding)
- [setMaxListeners](node_crypto_.CipherCCM.md#setmaxlisteners)
- [tee](node_crypto_.CipherCCM.md#tee)
- [uncork](node_crypto_.CipherCCM.md#uncork)
- [unpipe](node_crypto_.CipherCCM.md#unpipe)
- [unshift](node_crypto_.CipherCCM.md#unshift)
- [update](node_crypto_.CipherCCM.md#update)
- [wrap](node_crypto_.CipherCCM.md#wrap)
- [write](node_crypto_.CipherCCM.md#write)
...
▸ **addListener**(`event`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
[`CipherCCM`](crypto_.CipherCCM.md)
...
The buffered data will be flushed when either the [uncork](node_crypto_.CipherCCM.md#uncork) or [end](node_crypto_.CipherCCM.md#end) methods are called.
...
▸ **destroy**(`error?`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **end**(`cb?`): [`CipherCCM`](crypto_.CipherCCM.md)
...
Calling the [write](node_crypto_.CipherCCM.md#write) method after calling [end](node_crypto_.CipherCCM.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`CipherCCM`](crypto_.CipherCCM.md)
...
[crypto.d.ts:957](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L957)
...
[dist/types.d.ts:16976](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L16976)
...
▸ **off**(`eventName`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **on**(`event`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **once**(`event`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **pause**(): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **prependListener**(`event`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
Calling [read](node_crypto_.CipherCCM.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **removeListener**(`event`, `listener`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **resume**(): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **setAAD**(`buffer`, `options`): [`CipherCCM`](crypto_.CipherCCM.md)
...
[crypto.d.ts:951](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L951)
...
[dist/types.d.ts:16970](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L16970)

___

### setAutoPadding

▸ **setAutoPadding**(`autoPadding?`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **setDefaultEncoding**(`encoding`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **setEncoding**(`encoding`): [`CipherCCM`](crypto_.CipherCCM.md)
...
▸ **setMaxListeners**(`n`): [`CipherCCM`](crypto_.CipherCCM.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_crypto_.CipherCCM.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`CipherCCM`](crypto_.CipherCCM.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_crypto_.CipherCCM.md#pipe) method.
...
Unlike [push](node_crypto_.CipherCCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_crypto_.CipherCCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_crypto_.CipherCCM.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`CipherCCM`](crypto_.CipherCCM.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_crypto_.CipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_crypto_.CipherCCM.md#pipe). However, if calling `write()` is preferred, it is
