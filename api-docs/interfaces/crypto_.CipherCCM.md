[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / CipherCCM

# Interface: CipherCCM

["crypto"](../modules/crypto_.md).CipherCCM
...
- [allowHalfOpen](crypto_.CipherCCM.md#allowhalfopen)
- [destroyed](crypto_.CipherCCM.md#destroyed)
- [locked](crypto_.CipherCCM.md#locked)
- [readable](crypto_.CipherCCM.md#readable)
- [readableAborted](crypto_.CipherCCM.md#readableaborted)
- [readableEncoding](crypto_.CipherCCM.md#readableencoding)
- [readableEnded](crypto_.CipherCCM.md#readableended)
- [readableFlowing](crypto_.CipherCCM.md#readableflowing)
- [readableHighWaterMark](crypto_.CipherCCM.md#readablehighwatermark)
- [readableLength](crypto_.CipherCCM.md#readablelength)
- [readableObjectMode](crypto_.CipherCCM.md#readableobjectmode)
- [writable](crypto_.CipherCCM.md#writable)
- [writableCorked](crypto_.CipherCCM.md#writablecorked)
- [writableEnded](crypto_.CipherCCM.md#writableended)
- [writableFinished](crypto_.CipherCCM.md#writablefinished)
- [writableHighWaterMark](crypto_.CipherCCM.md#writablehighwatermark)
- [writableLength](crypto_.CipherCCM.md#writablelength)
- [writableObjectMode](crypto_.CipherCCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto_.CipherCCM.md#[asynciterator])
- [\_construct](crypto_.CipherCCM.md#_construct)
- [\_destroy](crypto_.CipherCCM.md#_destroy)
- [\_final](crypto_.CipherCCM.md#_final)
- [\_flush](crypto_.CipherCCM.md#_flush)
- [\_read](crypto_.CipherCCM.md#_read)
- [\_transform](crypto_.CipherCCM.md#_transform)
- [\_write](crypto_.CipherCCM.md#_write)
- [\_writev](crypto_.CipherCCM.md#_writev)
- [abort](crypto_.CipherCCM.md#abort)
- [addListener](crypto_.CipherCCM.md#addlistener)
- [cancel](crypto_.CipherCCM.md#cancel)
- [close](crypto_.CipherCCM.md#close)
- [cork](crypto_.CipherCCM.md#cork)
- [destroy](crypto_.CipherCCM.md#destroy)
- [emit](crypto_.CipherCCM.md#emit)
- [end](crypto_.CipherCCM.md#end)
- [eventNames](crypto_.CipherCCM.md#eventnames)
- [final](crypto_.CipherCCM.md#final)
- [forEach](crypto_.CipherCCM.md#foreach)
- [getAuthTag](crypto_.CipherCCM.md#getauthtag)
- [getMaxListeners](crypto_.CipherCCM.md#getmaxlisteners)
- [getReader](crypto_.CipherCCM.md#getreader)
- [getWriter](crypto_.CipherCCM.md#getwriter)
- [isPaused](crypto_.CipherCCM.md#ispaused)
- [listenerCount](crypto_.CipherCCM.md#listenercount)
- [listeners](crypto_.CipherCCM.md#listeners)
- [off](crypto_.CipherCCM.md#off)
- [on](crypto_.CipherCCM.md#on)
- [once](crypto_.CipherCCM.md#once)
- [pause](crypto_.CipherCCM.md#pause)
- [pipe](crypto_.CipherCCM.md#pipe)
- [pipeThrough](crypto_.CipherCCM.md#pipethrough)
- [pipeTo](crypto_.CipherCCM.md#pipeto)
- [prependListener](crypto_.CipherCCM.md#prependlistener)
- [prependOnceListener](crypto_.CipherCCM.md#prependoncelistener)
- [push](crypto_.CipherCCM.md#push)
- [rawListeners](crypto_.CipherCCM.md#rawlisteners)
- [read](crypto_.CipherCCM.md#read)
- [removeAllListeners](crypto_.CipherCCM.md#removealllisteners)
- [removeListener](crypto_.CipherCCM.md#removelistener)
- [resume](crypto_.CipherCCM.md#resume)
- [setAAD](crypto_.CipherCCM.md#setaad)
- [setAutoPadding](crypto_.CipherCCM.md#setautopadding)
- [setDefaultEncoding](crypto_.CipherCCM.md#setdefaultencoding)
- [setEncoding](crypto_.CipherCCM.md#setencoding)
- [setMaxListeners](crypto_.CipherCCM.md#setmaxlisteners)
- [tee](crypto_.CipherCCM.md#tee)
- [uncork](crypto_.CipherCCM.md#uncork)
- [unpipe](crypto_.CipherCCM.md#unpipe)
- [unshift](crypto_.CipherCCM.md#unshift)
- [update](crypto_.CipherCCM.md#update)
- [wrap](crypto_.CipherCCM.md#wrap)
- [write](crypto_.CipherCCM.md#write)
...
The buffered data will be flushed when either the [uncork](crypto_.CipherCCM.md#uncork) or [end](crypto_.CipherCCM.md#end) methods are called.
...
Calling the [write](crypto_.CipherCCM.md#write) method after calling [end](crypto_.CipherCCM.md#end) will raise an error.
...
Calling [read](crypto_.CipherCCM.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.CipherCCM.md#cork) was called.
...
using the [pipe](crypto_.CipherCCM.md#pipe) method.
...
Unlike [push](crypto_.CipherCCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.CipherCCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.CipherCCM.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.CipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.CipherCCM.md#pipe). However, if calling `write()` is preferred, it is
