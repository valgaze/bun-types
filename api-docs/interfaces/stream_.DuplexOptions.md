[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](../modules/stream_.md) / DuplexOptions

# Interface: DuplexOptions

["stream"](../modules/stream_.md).DuplexOptions
...
- [`WritableOptions`](stream_.WritableOptions.md)
  ...
  ↳↳ [`TransformOptions`](node_stream_.TransformOptions.md)

## Table of contents

### Properties

- [allowHalfOpen](stream_.DuplexOptions.md#allowhalfopen)
- [autoDestroy](stream_.DuplexOptions.md#autodestroy)
- [decodeStrings](stream_.DuplexOptions.md#decodestrings)
- [defaultEncoding](stream_.DuplexOptions.md#defaultencoding)
- [emitClose](stream_.DuplexOptions.md#emitclose)
- [encoding](stream_.DuplexOptions.md#encoding)
- [highWaterMark](stream_.DuplexOptions.md#highwatermark)
- [objectMode](stream_.DuplexOptions.md#objectmode)
- [readableHighWaterMark](stream_.DuplexOptions.md#readablehighwatermark)
- [readableObjectMode](stream_.DuplexOptions.md#readableobjectmode)
- [signal](stream_.DuplexOptions.md#signal)
- [writableCorked](stream_.DuplexOptions.md#writablecorked)
- [writableHighWaterMark](stream_.DuplexOptions.md#writablehighwatermark)
- [writableObjectMode](stream_.DuplexOptions.md#writableobjectmode)

### Methods

- [construct](stream_.DuplexOptions.md#construct)
- [destroy](stream_.DuplexOptions.md#destroy)
- [final](stream_.DuplexOptions.md#final)
- [read](stream_.DuplexOptions.md#read)
- [write](stream_.DuplexOptions.md#write)
- [writev](stream_.DuplexOptions.md#writev)
