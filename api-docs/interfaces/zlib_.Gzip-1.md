[bun-types](../README.md) / [Exports](../modules.md) / ["zlib"](../modules/zlib_.md) / Gzip

# Interface: Gzip

["zlib"](../modules/zlib_.md).Gzip
...
- [allowHalfOpen](zlib_.Gzip-1.md#allowhalfopen)
- [bytesRead](zlib_.Gzip-1.md#bytesread)
- [bytesWritten](zlib_.Gzip-1.md#byteswritten)
- [destroyed](zlib_.Gzip-1.md#destroyed)
- [locked](zlib_.Gzip-1.md#locked)
- [readable](zlib_.Gzip-1.md#readable)
- [readableAborted](zlib_.Gzip-1.md#readableaborted)
- [readableEncoding](zlib_.Gzip-1.md#readableencoding)
- [readableEnded](zlib_.Gzip-1.md#readableended)
- [readableFlowing](zlib_.Gzip-1.md#readableflowing)
- [readableHighWaterMark](zlib_.Gzip-1.md#readablehighwatermark)
- [readableLength](zlib_.Gzip-1.md#readablelength)
- [readableObjectMode](zlib_.Gzip-1.md#readableobjectmode)
- [shell](zlib_.Gzip-1.md#shell)
- [writable](zlib_.Gzip-1.md#writable)
- [writableCorked](zlib_.Gzip-1.md#writablecorked)
- [writableEnded](zlib_.Gzip-1.md#writableended)
- [writableFinished](zlib_.Gzip-1.md#writablefinished)
- [writableHighWaterMark](zlib_.Gzip-1.md#writablehighwatermark)
- [writableLength](zlib_.Gzip-1.md#writablelength)
- [writableObjectMode](zlib_.Gzip-1.md#writableobjectmode)

### Methods

- [[asyncIterator]](zlib_.Gzip-1.md#[asynciterator])
- [\_construct](zlib_.Gzip-1.md#_construct)
- [\_destroy](zlib_.Gzip-1.md#_destroy)
- [\_final](zlib_.Gzip-1.md#_final)
- [\_flush](zlib_.Gzip-1.md#_flush)
- [\_read](zlib_.Gzip-1.md#_read)
- [\_transform](zlib_.Gzip-1.md#_transform)
- [\_write](zlib_.Gzip-1.md#_write)
- [\_writev](zlib_.Gzip-1.md#_writev)
- [abort](zlib_.Gzip-1.md#abort)
- [addListener](zlib_.Gzip-1.md#addlistener)
- [cancel](zlib_.Gzip-1.md#cancel)
- [close](zlib_.Gzip-1.md#close)
- [cork](zlib_.Gzip-1.md#cork)
- [destroy](zlib_.Gzip-1.md#destroy)
- [emit](zlib_.Gzip-1.md#emit)
- [end](zlib_.Gzip-1.md#end)
- [eventNames](zlib_.Gzip-1.md#eventnames)
- [flush](zlib_.Gzip-1.md#flush)
- [forEach](zlib_.Gzip-1.md#foreach)
- [getMaxListeners](zlib_.Gzip-1.md#getmaxlisteners)
- [getReader](zlib_.Gzip-1.md#getreader)
- [getWriter](zlib_.Gzip-1.md#getwriter)
- [isPaused](zlib_.Gzip-1.md#ispaused)
- [listenerCount](zlib_.Gzip-1.md#listenercount)
- [listeners](zlib_.Gzip-1.md#listeners)
- [off](zlib_.Gzip-1.md#off)
- [on](zlib_.Gzip-1.md#on)
- [once](zlib_.Gzip-1.md#once)
- [pause](zlib_.Gzip-1.md#pause)
- [pipe](zlib_.Gzip-1.md#pipe)
- [pipeThrough](zlib_.Gzip-1.md#pipethrough)
- [pipeTo](zlib_.Gzip-1.md#pipeto)
- [prependListener](zlib_.Gzip-1.md#prependlistener)
- [prependOnceListener](zlib_.Gzip-1.md#prependoncelistener)
- [push](zlib_.Gzip-1.md#push)
- [rawListeners](zlib_.Gzip-1.md#rawlisteners)
- [read](zlib_.Gzip-1.md#read)
- [removeAllListeners](zlib_.Gzip-1.md#removealllisteners)
- [removeListener](zlib_.Gzip-1.md#removelistener)
- [resume](zlib_.Gzip-1.md#resume)
- [setDefaultEncoding](zlib_.Gzip-1.md#setdefaultencoding)
- [setEncoding](zlib_.Gzip-1.md#setencoding)
- [setMaxListeners](zlib_.Gzip-1.md#setmaxlisteners)
- [tee](zlib_.Gzip-1.md#tee)
- [uncork](zlib_.Gzip-1.md#uncork)
- [unpipe](zlib_.Gzip-1.md#unpipe)
- [unshift](zlib_.Gzip-1.md#unshift)
- [wrap](zlib_.Gzip-1.md#wrap)
- [write](zlib_.Gzip-1.md#write)
...
The buffered data will be flushed when either the [uncork](zlib_.Gzip-1.md#uncork) or [end](zlib_.Gzip-1.md#end) methods are called.
...
Calling the [write](zlib_.Gzip-1.md#write) method after calling [end](zlib_.Gzip-1.md#end) will raise an error.
...
Calling [read](zlib_.Gzip-1.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](zlib_.Gzip-1.md#cork) was called.
...
using the [pipe](zlib_.Gzip-1.md#pipe) method.
...
Unlike [push](zlib_.Gzip-1.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](zlib_.Gzip-1.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](zlib_.Gzip-1.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](zlib_.Gzip-1.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](zlib_.Gzip-1.md#pipe). However, if calling `write()` is preferred, it is
