[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / CipherGCM

# Interface: CipherGCM

["crypto"](../modules/crypto_.md).CipherGCM
...
- [allowHalfOpen](crypto_.CipherGCM.md#allowhalfopen)
- [destroyed](crypto_.CipherGCM.md#destroyed)
- [locked](crypto_.CipherGCM.md#locked)
- [readable](crypto_.CipherGCM.md#readable)
- [readableAborted](crypto_.CipherGCM.md#readableaborted)
- [readableEncoding](crypto_.CipherGCM.md#readableencoding)
- [readableEnded](crypto_.CipherGCM.md#readableended)
- [readableFlowing](crypto_.CipherGCM.md#readableflowing)
- [readableHighWaterMark](crypto_.CipherGCM.md#readablehighwatermark)
- [readableLength](crypto_.CipherGCM.md#readablelength)
- [readableObjectMode](crypto_.CipherGCM.md#readableobjectmode)
- [writable](crypto_.CipherGCM.md#writable)
- [writableCorked](crypto_.CipherGCM.md#writablecorked)
- [writableEnded](crypto_.CipherGCM.md#writableended)
- [writableFinished](crypto_.CipherGCM.md#writablefinished)
- [writableHighWaterMark](crypto_.CipherGCM.md#writablehighwatermark)
- [writableLength](crypto_.CipherGCM.md#writablelength)
- [writableObjectMode](crypto_.CipherGCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto_.CipherGCM.md#[asynciterator])
- [\_construct](crypto_.CipherGCM.md#_construct)
- [\_destroy](crypto_.CipherGCM.md#_destroy)
- [\_final](crypto_.CipherGCM.md#_final)
- [\_flush](crypto_.CipherGCM.md#_flush)
- [\_read](crypto_.CipherGCM.md#_read)
- [\_transform](crypto_.CipherGCM.md#_transform)
- [\_write](crypto_.CipherGCM.md#_write)
- [\_writev](crypto_.CipherGCM.md#_writev)
- [abort](crypto_.CipherGCM.md#abort)
- [addListener](crypto_.CipherGCM.md#addlistener)
- [cancel](crypto_.CipherGCM.md#cancel)
- [close](crypto_.CipherGCM.md#close)
- [cork](crypto_.CipherGCM.md#cork)
- [destroy](crypto_.CipherGCM.md#destroy)
- [emit](crypto_.CipherGCM.md#emit)
- [end](crypto_.CipherGCM.md#end)
- [eventNames](crypto_.CipherGCM.md#eventnames)
- [final](crypto_.CipherGCM.md#final)
- [forEach](crypto_.CipherGCM.md#foreach)
- [getAuthTag](crypto_.CipherGCM.md#getauthtag)
- [getMaxListeners](crypto_.CipherGCM.md#getmaxlisteners)
- [getReader](crypto_.CipherGCM.md#getreader)
- [getWriter](crypto_.CipherGCM.md#getwriter)
- [isPaused](crypto_.CipherGCM.md#ispaused)
- [listenerCount](crypto_.CipherGCM.md#listenercount)
- [listeners](crypto_.CipherGCM.md#listeners)
- [off](crypto_.CipherGCM.md#off)
- [on](crypto_.CipherGCM.md#on)
- [once](crypto_.CipherGCM.md#once)
- [pause](crypto_.CipherGCM.md#pause)
- [pipe](crypto_.CipherGCM.md#pipe)
- [pipeThrough](crypto_.CipherGCM.md#pipethrough)
- [pipeTo](crypto_.CipherGCM.md#pipeto)
- [prependListener](crypto_.CipherGCM.md#prependlistener)
- [prependOnceListener](crypto_.CipherGCM.md#prependoncelistener)
- [push](crypto_.CipherGCM.md#push)
- [rawListeners](crypto_.CipherGCM.md#rawlisteners)
- [read](crypto_.CipherGCM.md#read)
- [removeAllListeners](crypto_.CipherGCM.md#removealllisteners)
- [removeListener](crypto_.CipherGCM.md#removelistener)
- [resume](crypto_.CipherGCM.md#resume)
- [setAAD](crypto_.CipherGCM.md#setaad)
- [setAutoPadding](crypto_.CipherGCM.md#setautopadding)
- [setDefaultEncoding](crypto_.CipherGCM.md#setdefaultencoding)
- [setEncoding](crypto_.CipherGCM.md#setencoding)
- [setMaxListeners](crypto_.CipherGCM.md#setmaxlisteners)
- [tee](crypto_.CipherGCM.md#tee)
- [uncork](crypto_.CipherGCM.md#uncork)
- [unpipe](crypto_.CipherGCM.md#unpipe)
- [unshift](crypto_.CipherGCM.md#unshift)
- [update](crypto_.CipherGCM.md#update)
- [wrap](crypto_.CipherGCM.md#wrap)
- [write](crypto_.CipherGCM.md#write)
...
The buffered data will be flushed when either the [uncork](crypto_.CipherGCM.md#uncork) or [end](crypto_.CipherGCM.md#end) methods are called.
...
Calling the [write](crypto_.CipherGCM.md#write) method after calling [end](crypto_.CipherGCM.md#end) will raise an error.
...
Calling [read](crypto_.CipherGCM.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`CipherGCM`](crypto_.CipherGCM.md)
...
[crypto.d.ts:960](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L960)
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.CipherGCM.md#cork) was called.
...
using the [pipe](crypto_.CipherGCM.md#pipe) method.
...
Unlike [push](crypto_.CipherGCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.CipherGCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.CipherGCM.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.CipherGCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.CipherGCM.md#pipe). However, if calling `write()` is preferred, it is
