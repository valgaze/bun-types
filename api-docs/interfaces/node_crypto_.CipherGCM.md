[bun-types](../README.md) / [Exports](../modules.md) / ["node:crypto"](../modules/node_crypto_.md) / CipherGCM
...
- [off](node_crypto_.CipherGCM.md#off)
...
Unlike [push](node_crypto_.CipherGCM.md#push), `stream.unshift(chunk)` will not
