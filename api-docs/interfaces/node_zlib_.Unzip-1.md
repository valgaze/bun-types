[bun-types](../README.md) / [Exports](../modules.md) / ["node:zlib"](../modules/node_zlib_.md) / Unzip

# Interface: Unzip

["node:zlib"](../modules/node_zlib_.md).Unzip
...
- [allowHalfOpen](node_zlib_.Unzip-1.md#allowhalfopen)
- [bytesRead](node_zlib_.Unzip-1.md#bytesread)
- [bytesWritten](node_zlib_.Unzip-1.md#byteswritten)
- [destroyed](node_zlib_.Unzip-1.md#destroyed)
- [locked](node_zlib_.Unzip-1.md#locked)
- [readable](node_zlib_.Unzip-1.md#readable)
- [readableAborted](node_zlib_.Unzip-1.md#readableaborted)
- [readableEncoding](node_zlib_.Unzip-1.md#readableencoding)
- [readableEnded](node_zlib_.Unzip-1.md#readableended)
- [readableFlowing](node_zlib_.Unzip-1.md#readableflowing)
- [readableHighWaterMark](node_zlib_.Unzip-1.md#readablehighwatermark)
- [readableLength](node_zlib_.Unzip-1.md#readablelength)
- [readableObjectMode](node_zlib_.Unzip-1.md#readableobjectmode)
- [shell](node_zlib_.Unzip-1.md#shell)
- [writable](node_zlib_.Unzip-1.md#writable)
- [writableCorked](node_zlib_.Unzip-1.md#writablecorked)
- [writableEnded](node_zlib_.Unzip-1.md#writableended)
- [writableFinished](node_zlib_.Unzip-1.md#writablefinished)
- [writableHighWaterMark](node_zlib_.Unzip-1.md#writablehighwatermark)
- [writableLength](node_zlib_.Unzip-1.md#writablelength)
- [writableObjectMode](node_zlib_.Unzip-1.md#writableobjectmode)

### Methods

- [[asyncIterator]](node_zlib_.Unzip-1.md#[asynciterator])
- [\_construct](node_zlib_.Unzip-1.md#_construct)
- [\_destroy](node_zlib_.Unzip-1.md#_destroy)
- [\_final](node_zlib_.Unzip-1.md#_final)
- [\_flush](node_zlib_.Unzip-1.md#_flush)
- [\_read](node_zlib_.Unzip-1.md#_read)
- [\_transform](node_zlib_.Unzip-1.md#_transform)
- [\_write](node_zlib_.Unzip-1.md#_write)
- [\_writev](node_zlib_.Unzip-1.md#_writev)
- [abort](node_zlib_.Unzip-1.md#abort)
- [addListener](node_zlib_.Unzip-1.md#addlistener)
- [cancel](node_zlib_.Unzip-1.md#cancel)
- [close](node_zlib_.Unzip-1.md#close)
- [cork](node_zlib_.Unzip-1.md#cork)
- [destroy](node_zlib_.Unzip-1.md#destroy)
- [emit](node_zlib_.Unzip-1.md#emit)
- [end](node_zlib_.Unzip-1.md#end)
- [eventNames](node_zlib_.Unzip-1.md#eventnames)
- [flush](node_zlib_.Unzip-1.md#flush)
- [forEach](node_zlib_.Unzip-1.md#foreach)
- [getMaxListeners](node_zlib_.Unzip-1.md#getmaxlisteners)
- [getReader](node_zlib_.Unzip-1.md#getreader)
- [getWriter](node_zlib_.Unzip-1.md#getwriter)
- [isPaused](node_zlib_.Unzip-1.md#ispaused)
- [listenerCount](node_zlib_.Unzip-1.md#listenercount)
- [listeners](node_zlib_.Unzip-1.md#listeners)
- [off](node_zlib_.Unzip-1.md#off)
- [on](node_zlib_.Unzip-1.md#on)
- [once](node_zlib_.Unzip-1.md#once)
- [pause](node_zlib_.Unzip-1.md#pause)
- [pipe](node_zlib_.Unzip-1.md#pipe)
- [pipeThrough](node_zlib_.Unzip-1.md#pipethrough)
- [pipeTo](node_zlib_.Unzip-1.md#pipeto)
- [prependListener](node_zlib_.Unzip-1.md#prependlistener)
- [prependOnceListener](node_zlib_.Unzip-1.md#prependoncelistener)
- [push](node_zlib_.Unzip-1.md#push)
- [rawListeners](node_zlib_.Unzip-1.md#rawlisteners)
- [read](node_zlib_.Unzip-1.md#read)
- [removeAllListeners](node_zlib_.Unzip-1.md#removealllisteners)
- [removeListener](node_zlib_.Unzip-1.md#removelistener)
- [resume](node_zlib_.Unzip-1.md#resume)
- [setDefaultEncoding](node_zlib_.Unzip-1.md#setdefaultencoding)
- [setEncoding](node_zlib_.Unzip-1.md#setencoding)
- [setMaxListeners](node_zlib_.Unzip-1.md#setmaxlisteners)
- [tee](node_zlib_.Unzip-1.md#tee)
- [uncork](node_zlib_.Unzip-1.md#uncork)
- [unpipe](node_zlib_.Unzip-1.md#unpipe)
- [unshift](node_zlib_.Unzip-1.md#unshift)
- [wrap](node_zlib_.Unzip-1.md#wrap)
- [write](node_zlib_.Unzip-1.md#write)
...
▸ **addListener**(`event`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
The buffered data will be flushed when either the [uncork](node_zlib_.Unzip-1.md#uncork) or [end](node_zlib_.Unzip-1.md#end) methods are called.
...
▸ **destroy**(`error?`): [`Unzip`](zlib_.Unzip-1.md)
...
Calling the [write](node_zlib_.Unzip-1.md#write) method after calling [end](node_zlib_.Unzip-1.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **off**(`eventName`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **on**(`event`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **once**(`event`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **prependListener**(`event`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
Calling [read](node_zlib_.Unzip-1.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **removeListener**(`event`, `listener`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **setDefaultEncoding**(`encoding`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **setEncoding**(`encoding`): [`Unzip`](zlib_.Unzip-1.md)
...
▸ **setMaxListeners**(`n`): [`Unzip`](zlib_.Unzip-1.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_zlib_.Unzip-1.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`Unzip`](zlib_.Unzip-1.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_zlib_.Unzip-1.md#pipe) method.
...
Unlike [push](node_zlib_.Unzip-1.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_zlib_.Unzip-1.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_zlib_.Unzip-1.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`Unzip`](zlib_.Unzip-1.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_zlib_.Unzip-1.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_zlib_.Unzip-1.md#pipe). However, if calling `write()` is preferred, it is
