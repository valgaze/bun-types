[bun-types](../README.md) / [Exports](../modules.md) / ErrorEvent
...
- [AT\_TARGET](ErrorEvent.md#at_target)
- [BUBBLING\_PHASE](ErrorEvent.md#bubbling_phase)
- [CAPTURING\_PHASE](ErrorEvent.md#capturing_phase)
- [NONE](ErrorEvent.md#none)
- [bubbles](ErrorEvent.md#bubbles)
- [cancelBubble](ErrorEvent.md#cancelbubble)
- [cancelable](ErrorEvent.md#cancelable)
- [colno](ErrorEvent.md#colno)
- [composed](ErrorEvent.md#composed)
- [currentTarget](ErrorEvent.md#currenttarget)
- [defaultPrevented](ErrorEvent.md#defaultprevented)
- [error](ErrorEvent.md#error)
- [eventPhase](ErrorEvent.md#eventphase)
- [filename](ErrorEvent.md#filename)
- [isTrusted](ErrorEvent.md#istrusted)
- [lineno](ErrorEvent.md#lineno)
- [message](ErrorEvent.md#message)
- [returnValue](ErrorEvent.md#returnvalue)
- [srcElement](ErrorEvent.md#srcelement)
- [target](ErrorEvent.md#target)
- [timeStamp](ErrorEvent.md#timestamp)
- [type](ErrorEvent.md#type)

### Methods

- [composedPath](ErrorEvent.md#composedpath)
- [initEvent](ErrorEvent.md#initevent)
- [preventDefault](ErrorEvent.md#preventdefault)
- [stopImmediatePropagation](ErrorEvent.md#stopimmediatepropagation)
- [stopPropagation](ErrorEvent.md#stoppropagation)
...
[globals.d.ts:1288](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1288)

[dist/types.d.ts:9858](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9858)
...
[globals.d.ts:1289](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1289)

[dist/types.d.ts:9859](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9859)
...
[globals.d.ts:1290](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1290)

[dist/types.d.ts:9860](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9860)
...
[globals.d.ts:1291](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1291)

[dist/types.d.ts:9861](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9861)
...
[globals.d.ts:1292](https://github.com/valgaze/bun-types/blob/5e53f27/globals.d.ts#L1292)

[dist/types.d.ts:9862](https://github.com/valgaze/bun-types/blob/5e53f27/dist/types.d.ts#L9862)
