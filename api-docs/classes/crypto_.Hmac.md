[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / Hmac

# Class: Hmac

["crypto"](../modules/crypto_.md).Hmac
...
The [createHmac](../modules/crypto_.md#createhmac) method is used to create `Hmac` instances. `Hmac`objects are not to be created directly using the `new` keyword.
...
- [constructor](crypto_.Hmac.md#constructor)

### Properties

- [allowHalfOpen](crypto_.Hmac.md#allowhalfopen)
- [destroyed](crypto_.Hmac.md#destroyed)
- [locked](crypto_.Hmac.md#locked)
- [readable](crypto_.Hmac.md#readable)
- [readableAborted](crypto_.Hmac.md#readableaborted)
- [readableEncoding](crypto_.Hmac.md#readableencoding)
- [readableEnded](crypto_.Hmac.md#readableended)
- [readableFlowing](crypto_.Hmac.md#readableflowing)
- [readableHighWaterMark](crypto_.Hmac.md#readablehighwatermark)
- [readableLength](crypto_.Hmac.md#readablelength)
- [readableObjectMode](crypto_.Hmac.md#readableobjectmode)
- [writable](crypto_.Hmac.md#writable)
- [writableCorked](crypto_.Hmac.md#writablecorked)
- [writableEnded](crypto_.Hmac.md#writableended)
- [writableFinished](crypto_.Hmac.md#writablefinished)
- [writableHighWaterMark](crypto_.Hmac.md#writablehighwatermark)
- [writableLength](crypto_.Hmac.md#writablelength)
- [writableObjectMode](crypto_.Hmac.md#writableobjectmode)
- [captureRejectionSymbol](crypto_.Hmac.md#capturerejectionsymbol)
- [captureRejections](crypto_.Hmac.md#capturerejections)
- [defaultMaxListeners](crypto_.Hmac.md#defaultmaxlisteners)
- [errorMonitor](crypto_.Hmac.md#errormonitor)

### Methods

- [[asyncIterator]](crypto_.Hmac.md#[asynciterator])
- [\_construct](crypto_.Hmac.md#_construct)
- [\_destroy](crypto_.Hmac.md#_destroy)
- [\_final](crypto_.Hmac.md#_final)
- [\_flush](crypto_.Hmac.md#_flush)
- [\_read](crypto_.Hmac.md#_read)
- [\_transform](crypto_.Hmac.md#_transform)
- [\_write](crypto_.Hmac.md#_write)
- [\_writev](crypto_.Hmac.md#_writev)
- [abort](crypto_.Hmac.md#abort)
- [addListener](crypto_.Hmac.md#addlistener)
- [cancel](crypto_.Hmac.md#cancel)
- [close](crypto_.Hmac.md#close)
- [cork](crypto_.Hmac.md#cork)
- [destroy](crypto_.Hmac.md#destroy)
- [digest](crypto_.Hmac.md#digest)
- [emit](crypto_.Hmac.md#emit)
- [end](crypto_.Hmac.md#end)
- [eventNames](crypto_.Hmac.md#eventnames)
- [forEach](crypto_.Hmac.md#foreach)
- [getMaxListeners](crypto_.Hmac.md#getmaxlisteners)
- [getReader](crypto_.Hmac.md#getreader)
- [getWriter](crypto_.Hmac.md#getwriter)
- [isPaused](crypto_.Hmac.md#ispaused)
- [listenerCount](crypto_.Hmac.md#listenercount)
- [listeners](crypto_.Hmac.md#listeners)
- [off](crypto_.Hmac.md#off)
- [on](crypto_.Hmac.md#on)
- [once](crypto_.Hmac.md#once)
- [pause](crypto_.Hmac.md#pause)
- [pipe](crypto_.Hmac.md#pipe)
- [pipeThrough](crypto_.Hmac.md#pipethrough)
- [pipeTo](crypto_.Hmac.md#pipeto)
- [prependListener](crypto_.Hmac.md#prependlistener)
- [prependOnceListener](crypto_.Hmac.md#prependoncelistener)
- [push](crypto_.Hmac.md#push)
- [rawListeners](crypto_.Hmac.md#rawlisteners)
- [read](crypto_.Hmac.md#read)
- [removeAllListeners](crypto_.Hmac.md#removealllisteners)
- [removeListener](crypto_.Hmac.md#removelistener)
- [resume](crypto_.Hmac.md#resume)
- [setDefaultEncoding](crypto_.Hmac.md#setdefaultencoding)
- [setEncoding](crypto_.Hmac.md#setencoding)
- [setMaxListeners](crypto_.Hmac.md#setmaxlisteners)
- [tee](crypto_.Hmac.md#tee)
- [uncork](crypto_.Hmac.md#uncork)
- [unpipe](crypto_.Hmac.md#unpipe)
- [unshift](crypto_.Hmac.md#unshift)
- [update](crypto_.Hmac.md#update)
- [wrap](crypto_.Hmac.md#wrap)
- [write](crypto_.Hmac.md#write)
- [from](crypto_.Hmac.md#from)
- [getEventListeners](crypto_.Hmac.md#geteventlisteners)
- [isDisturbed](crypto_.Hmac.md#isdisturbed)
- [listenerCount](crypto_.Hmac.md#listenercount-1)
- [on](crypto_.Hmac.md#on-1)
- [once](crypto_.Hmac.md#once-1)
- [setMaxListeners](crypto_.Hmac.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto_.Hmac.md#uncork) or [end](crypto_.Hmac.md#end) methods are called.
...
Calling the [write](crypto_.Hmac.md#write) method after calling [end](crypto_.Hmac.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto_.Hmac.md#defaultmaxlisteners).
...
Calling [read](crypto_.Hmac.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.Hmac.md#cork) was called.
...
using the [pipe](crypto_.Hmac.md#pipe) method.
...
Unlike [push](crypto_.Hmac.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.Hmac.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.Hmac.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.Hmac.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.Hmac.md#pipe). However, if calling `write()` is preferred, it is
