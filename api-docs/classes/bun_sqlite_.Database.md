[bun-types](../README.md) / [Exports](../modules.md) / ["bun:sqlite"](../modules/bun_sqlite_.md) / Database

# Class: Database

["bun:sqlite"](../modules/bun_sqlite_.md).Database

## Table of contents

### Constructors

- [constructor](bun_sqlite_.Database.md#constructor)

### Properties

- [filename](bun_sqlite_.Database.md#filename)
- [handle](bun_sqlite_.Database.md#handle)

### Accessors

- [inTransaction](bun_sqlite_.Database.md#intransaction)

### Methods

- [close](bun_sqlite_.Database.md#close)
- [exec](bun_sqlite_.Database.md#exec)
- [loadExtension](bun_sqlite_.Database.md#loadextension)
- [prepare](bun_sqlite_.Database.md#prepare)
- [query](bun_sqlite_.Database.md#query)
- [run](bun_sqlite_.Database.md#run)
- [transaction](bun_sqlite_.Database.md#transaction)
- [open](bun_sqlite_.Database.md#open)
- [setCustomSQLite](bun_sqlite_.Database.md#setcustomsqlite)
...
[sqlite.d.ts:62](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L62)
...
[sqlite.d.ts:277](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L277)
...
[sqlite.d.ts:284](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L284)
...
[sqlite.d.ts:249](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L249)
...
[sqlite.d.ts:266](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L266)
...
[sqlite.d.ts:175](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L175)
...
macOS requires a custom SQLite3 library to be linked because the Apple build of SQLite for macOS disables loading extensions. See [setCustomSQLite](bun_sqlite_.Database.md#setcustomsqlite)
...
[sqlite.d.ts:296](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L296)

___

### prepare

▸ **prepare**<`ParamsType`, `ReturnType`\>(`sql`, ...`params`): [`Statement`](bun_sqlite_.Statement.md)<`ParamsType`, `ReturnType`\>

Compile a SQL query and return a [Statement](bun_sqlite_.Statement.md) object.
...
[`Statement`](bun_sqlite_.Statement.md)<`ParamsType`, `ReturnType`\>
...
[sqlite.d.ts:230](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L230)

___

### query

▸ **query**<`ParamsType`, `ReturnType`\>(`sqlQuery`): [`Statement`](bun_sqlite_.Statement.md)<`ParamsType`, `ReturnType`\>

Compile a SQL query and return a [Statement](bun_sqlite_.Statement.md) object. This is the
same as [prepare](bun_sqlite_.Database.md#prepare) except that it caches the compiled query.
...
[sqlite.d.ts:205](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L205)
...
This does not cache the query, so if you want to run a query multiple times, you should use [prepare](bun_sqlite_.Database.md#prepare) instead.
...
[sqlite.d.ts:168](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L168)
...
[sqlite.d.ts:344](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L344)

___

### open

▸ `Static` **open**(`filename`, `options?`): [`Database`](bun_sqlite_.Database.md)

This is an alias of `new Database()`

See [Database](bun_sqlite_.Database.md)
...
[`Database`](bun_sqlite_.Database.md)

#### Defined in

[sqlite.d.ts:93](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L93)
...
[sqlite.d.ts:312](https://github.com/valgaze/bun-types/blob/5e53f27/sqlite.d.ts#L312)
