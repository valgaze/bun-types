[bun-types](../README.md) / [Exports](../modules.md) / ["node:crypto"](../modules/node_crypto_.md) / ECDH

# Class: ECDH

["node:crypto"](../modules/node_crypto_.md).ECDH

The `ECDH` class is a utility for creating Elliptic Curve Diffie-Hellman (ECDH)
key exchanges.

Instances of the `ECDH` class can be created using the [createECDH](../modules/node_crypto_.md#createecdh) function.
...
- [constructor](node_crypto_.ECDH.md#constructor)

### Methods

- [computeSecret](node_crypto_.ECDH.md#computesecret)
- [generateKeys](node_crypto_.ECDH.md#generatekeys)
- [getPrivateKey](node_crypto_.ECDH.md#getprivatekey)
- [getPublicKey](node_crypto_.ECDH.md#getpublickey)
- [setPrivateKey](node_crypto_.ECDH.md#setprivatekey)
- [convertKey](node_crypto_.ECDH.md#convertkey)
...
Use [getCurves](../modules/node_crypto_.md#getcurves) to obtain a list of available curve names.
