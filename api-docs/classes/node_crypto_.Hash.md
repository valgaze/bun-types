[bun-types](../README.md) / [Exports](../modules.md) / ["node:crypto"](../modules/node_crypto_.md) / Hash

# Class: Hash

["node:crypto"](../modules/node_crypto_.md).Hash
...
The [createHash](../modules/node_crypto_.md#createhash) method is used to create `Hash` instances. `Hash`objects are not to be created directly using the `new` keyword.
...
- [constructor](node_crypto_.Hash.md#constructor)

### Properties

- [allowHalfOpen](node_crypto_.Hash.md#allowhalfopen)
- [destroyed](node_crypto_.Hash.md#destroyed)
- [locked](node_crypto_.Hash.md#locked)
- [readable](node_crypto_.Hash.md#readable)
- [readableAborted](node_crypto_.Hash.md#readableaborted)
- [readableEncoding](node_crypto_.Hash.md#readableencoding)
- [readableEnded](node_crypto_.Hash.md#readableended)
- [readableFlowing](node_crypto_.Hash.md#readableflowing)
- [readableHighWaterMark](node_crypto_.Hash.md#readablehighwatermark)
- [readableLength](node_crypto_.Hash.md#readablelength)
- [readableObjectMode](node_crypto_.Hash.md#readableobjectmode)
- [writable](node_crypto_.Hash.md#writable)
- [writableCorked](node_crypto_.Hash.md#writablecorked)
- [writableEnded](node_crypto_.Hash.md#writableended)
- [writableFinished](node_crypto_.Hash.md#writablefinished)
- [writableHighWaterMark](node_crypto_.Hash.md#writablehighwatermark)
- [writableLength](node_crypto_.Hash.md#writablelength)
- [writableObjectMode](node_crypto_.Hash.md#writableobjectmode)
- [captureRejectionSymbol](node_crypto_.Hash.md#capturerejectionsymbol)
- [captureRejections](node_crypto_.Hash.md#capturerejections)
- [defaultMaxListeners](node_crypto_.Hash.md#defaultmaxlisteners)
- [errorMonitor](node_crypto_.Hash.md#errormonitor)

### Methods

- [[asyncIterator]](node_crypto_.Hash.md#[asynciterator])
- [\_construct](node_crypto_.Hash.md#_construct)
- [\_destroy](node_crypto_.Hash.md#_destroy)
- [\_final](node_crypto_.Hash.md#_final)
- [\_flush](node_crypto_.Hash.md#_flush)
- [\_read](node_crypto_.Hash.md#_read)
- [\_transform](node_crypto_.Hash.md#_transform)
- [\_write](node_crypto_.Hash.md#_write)
- [\_writev](node_crypto_.Hash.md#_writev)
- [abort](node_crypto_.Hash.md#abort)
- [addListener](node_crypto_.Hash.md#addlistener)
- [cancel](node_crypto_.Hash.md#cancel)
- [close](node_crypto_.Hash.md#close)
- [copy](node_crypto_.Hash.md#copy)
- [cork](node_crypto_.Hash.md#cork)
- [destroy](node_crypto_.Hash.md#destroy)
- [digest](node_crypto_.Hash.md#digest)
- [emit](node_crypto_.Hash.md#emit)
- [end](node_crypto_.Hash.md#end)
- [eventNames](node_crypto_.Hash.md#eventnames)
- [forEach](node_crypto_.Hash.md#foreach)
- [getMaxListeners](node_crypto_.Hash.md#getmaxlisteners)
- [getReader](node_crypto_.Hash.md#getreader)
- [getWriter](node_crypto_.Hash.md#getwriter)
- [isPaused](node_crypto_.Hash.md#ispaused)
- [listenerCount](node_crypto_.Hash.md#listenercount)
- [listeners](node_crypto_.Hash.md#listeners)
- [off](node_crypto_.Hash.md#off)
- [on](node_crypto_.Hash.md#on)
- [once](node_crypto_.Hash.md#once)
- [pause](node_crypto_.Hash.md#pause)
- [pipe](node_crypto_.Hash.md#pipe)
- [pipeThrough](node_crypto_.Hash.md#pipethrough)
- [pipeTo](node_crypto_.Hash.md#pipeto)
- [prependListener](node_crypto_.Hash.md#prependlistener)
- [prependOnceListener](node_crypto_.Hash.md#prependoncelistener)
- [push](node_crypto_.Hash.md#push)
- [rawListeners](node_crypto_.Hash.md#rawlisteners)
- [read](node_crypto_.Hash.md#read)
- [removeAllListeners](node_crypto_.Hash.md#removealllisteners)
- [removeListener](node_crypto_.Hash.md#removelistener)
- [resume](node_crypto_.Hash.md#resume)
- [setDefaultEncoding](node_crypto_.Hash.md#setdefaultencoding)
- [setEncoding](node_crypto_.Hash.md#setencoding)
- [setMaxListeners](node_crypto_.Hash.md#setmaxlisteners)
- [tee](node_crypto_.Hash.md#tee)
- [uncork](node_crypto_.Hash.md#uncork)
- [unpipe](node_crypto_.Hash.md#unpipe)
- [unshift](node_crypto_.Hash.md#unshift)
- [update](node_crypto_.Hash.md#update)
- [wrap](node_crypto_.Hash.md#wrap)
- [write](node_crypto_.Hash.md#write)
- [from](node_crypto_.Hash.md#from)
- [getEventListeners](node_crypto_.Hash.md#geteventlisteners)
- [isDisturbed](node_crypto_.Hash.md#isdisturbed)
- [listenerCount](node_crypto_.Hash.md#listenercount-1)
- [on](node_crypto_.Hash.md#on-1)
- [once](node_crypto_.Hash.md#once-1)
- [setMaxListeners](node_crypto_.Hash.md#setmaxlisteners-1)
...
[crypto.d.ts:349](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L349)
...
▸ **addListener**(`event`, `listener`): [`Hash`](crypto_.Hash.md)
...
▸ **copy**(`options?`): [`Hash`](crypto_.Hash.md)
...
[crypto.d.ts:382](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L382)
...
The buffered data will be flushed when either the [uncork](node_crypto_.Hash.md#uncork) or [end](node_crypto_.Hash.md#end) methods are called.
...
▸ **destroy**(`error?`): [`Hash`](crypto_.Hash.md)
...
▸ **digest**(): [`Buffer`](../modules/buffer_.md#buffer)
...
[crypto.d.ts:403](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L403)
...
[crypto.d.ts:404](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L404)
...
Calling the [write](node_crypto_.Hash.md#write) method after calling [end](node_crypto_.Hash.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`Hash`](crypto_.Hash.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`Hash`](crypto_.Hash.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_crypto_.Hash.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`Hash`](crypto_.Hash.md)
...
▸ **on**(`event`, `listener`): [`Hash`](crypto_.Hash.md)
...
▸ **once**(`event`, `listener`): [`Hash`](crypto_.Hash.md)
...
▸ **prependListener**(`event`, `listener`): [`Hash`](crypto_.Hash.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`Hash`](crypto_.Hash.md)
...
Calling [read](node_crypto_.Hash.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`Hash`](crypto_.Hash.md)
...
▸ **removeListener**(`event`, `listener`): [`Hash`](crypto_.Hash.md)
...
▸ **setDefaultEncoding**(`encoding`): [`Hash`](crypto_.Hash.md)
...
▸ **setEncoding**(`encoding`): [`Hash`](crypto_.Hash.md)
...
▸ **setMaxListeners**(`n`): [`Hash`](crypto_.Hash.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_crypto_.Hash.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`Hash`](crypto_.Hash.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_crypto_.Hash.md#pipe) method.
...
Unlike [push](node_crypto_.Hash.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_crypto_.Hash.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_crypto_.Hash.md#push) will reset the reading state appropriately,
...
▸ **update**(`data`): [`Hash`](crypto_.Hash.md)
...
[crypto.d.ts:392](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L392)

▸ **update**(`data`, `inputEncoding`): [`Hash`](crypto_.Hash.md)
...
[crypto.d.ts:393](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L393)

___

### wrap

▸ **wrap**(`stream`): [`Hash`](crypto_.Hash.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_crypto_.Hash.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_crypto_.Hash.md#pipe). However, if calling `write()` is preferred, it is
