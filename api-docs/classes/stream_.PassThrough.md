[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](../modules/stream_.md) / PassThrough

# Class: PassThrough

["stream"](../modules/stream_.md).PassThrough
...
- [constructor](stream_.PassThrough.md#constructor)

### Properties

- [allowHalfOpen](stream_.PassThrough.md#allowhalfopen)
- [destroyed](stream_.PassThrough.md#destroyed)
- [locked](stream_.PassThrough.md#locked)
- [readable](stream_.PassThrough.md#readable)
- [readableAborted](stream_.PassThrough.md#readableaborted)
- [readableEncoding](stream_.PassThrough.md#readableencoding)
- [readableEnded](stream_.PassThrough.md#readableended)
- [readableFlowing](stream_.PassThrough.md#readableflowing)
- [readableHighWaterMark](stream_.PassThrough.md#readablehighwatermark)
- [readableLength](stream_.PassThrough.md#readablelength)
- [readableObjectMode](stream_.PassThrough.md#readableobjectmode)
- [writable](stream_.PassThrough.md#writable)
- [writableCorked](stream_.PassThrough.md#writablecorked)
- [writableEnded](stream_.PassThrough.md#writableended)
- [writableFinished](stream_.PassThrough.md#writablefinished)
- [writableHighWaterMark](stream_.PassThrough.md#writablehighwatermark)
- [writableLength](stream_.PassThrough.md#writablelength)
- [writableObjectMode](stream_.PassThrough.md#writableobjectmode)
- [captureRejectionSymbol](stream_.PassThrough.md#capturerejectionsymbol)
- [captureRejections](stream_.PassThrough.md#capturerejections)
- [defaultMaxListeners](stream_.PassThrough.md#defaultmaxlisteners)
- [errorMonitor](stream_.PassThrough.md#errormonitor)

### Methods

- [[asyncIterator]](stream_.PassThrough.md#[asynciterator])
- [\_construct](stream_.PassThrough.md#_construct)
- [\_destroy](stream_.PassThrough.md#_destroy)
- [\_final](stream_.PassThrough.md#_final)
- [\_flush](stream_.PassThrough.md#_flush)
- [\_read](stream_.PassThrough.md#_read)
- [\_transform](stream_.PassThrough.md#_transform)
- [\_write](stream_.PassThrough.md#_write)
- [\_writev](stream_.PassThrough.md#_writev)
- [abort](stream_.PassThrough.md#abort)
- [addListener](stream_.PassThrough.md#addlistener)
- [cancel](stream_.PassThrough.md#cancel)
- [close](stream_.PassThrough.md#close)
- [cork](stream_.PassThrough.md#cork)
- [destroy](stream_.PassThrough.md#destroy)
- [emit](stream_.PassThrough.md#emit)
- [end](stream_.PassThrough.md#end)
- [eventNames](stream_.PassThrough.md#eventnames)
- [forEach](stream_.PassThrough.md#foreach)
- [getMaxListeners](stream_.PassThrough.md#getmaxlisteners)
- [getReader](stream_.PassThrough.md#getreader)
- [getWriter](stream_.PassThrough.md#getwriter)
- [isPaused](stream_.PassThrough.md#ispaused)
- [listenerCount](stream_.PassThrough.md#listenercount)
- [listeners](stream_.PassThrough.md#listeners)
- [off](stream_.PassThrough.md#off)
- [on](stream_.PassThrough.md#on)
- [once](stream_.PassThrough.md#once)
- [pause](stream_.PassThrough.md#pause)
- [pipe](stream_.PassThrough.md#pipe)
- [pipeThrough](stream_.PassThrough.md#pipethrough)
- [pipeTo](stream_.PassThrough.md#pipeto)
- [prependListener](stream_.PassThrough.md#prependlistener)
- [prependOnceListener](stream_.PassThrough.md#prependoncelistener)
- [push](stream_.PassThrough.md#push)
- [rawListeners](stream_.PassThrough.md#rawlisteners)
- [read](stream_.PassThrough.md#read)
- [removeAllListeners](stream_.PassThrough.md#removealllisteners)
- [removeListener](stream_.PassThrough.md#removelistener)
- [resume](stream_.PassThrough.md#resume)
- [setDefaultEncoding](stream_.PassThrough.md#setdefaultencoding)
- [setEncoding](stream_.PassThrough.md#setencoding)
- [setMaxListeners](stream_.PassThrough.md#setmaxlisteners)
- [tee](stream_.PassThrough.md#tee)
- [uncork](stream_.PassThrough.md#uncork)
- [unpipe](stream_.PassThrough.md#unpipe)
- [unshift](stream_.PassThrough.md#unshift)
- [wrap](stream_.PassThrough.md#wrap)
- [write](stream_.PassThrough.md#write)
- [from](stream_.PassThrough.md#from)
- [getEventListeners](stream_.PassThrough.md#geteventlisteners)
- [isDisturbed](stream_.PassThrough.md#isdisturbed)
- [listenerCount](stream_.PassThrough.md#listenercount-1)
- [on](stream_.PassThrough.md#on-1)
- [once](stream_.PassThrough.md#once-1)
- [setMaxListeners](stream_.PassThrough.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](stream_.PassThrough.md#uncork) or [end](stream_.PassThrough.md#end) methods are called.
...
Calling the [write](stream_.PassThrough.md#write) method after calling [end](stream_.PassThrough.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream_.PassThrough.md#defaultmaxlisteners).
...
Calling [read](stream_.PassThrough.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](stream_.PassThrough.md#cork) was called.
...
using the [pipe](stream_.PassThrough.md#pipe) method.
...
Unlike [push](stream_.PassThrough.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream_.PassThrough.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream_.PassThrough.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream_.PassThrough.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream_.PassThrough.md#pipe). However, if calling `write()` is preferred, it is
