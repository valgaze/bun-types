[bun-types](../README.md) / [Exports](../modules.md) / ["node:https"](../modules/node_https_.md) / IncomingMessage

# Class: IncomingMessage

["node:https"](../modules/node_https_.md).IncomingMessage

An `IncomingMessage` object is created by Server or [ClientRequest](node_https_.ClientRequest.md) and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
...
- [constructor](node_https_.IncomingMessage.md#constructor)

### Properties

- [aborted](node_https_.IncomingMessage.md#aborted)
- [complete](node_https_.IncomingMessage.md#complete)
- [destroyed](node_https_.IncomingMessage.md#destroyed)
- [headers](node_https_.IncomingMessage.md#headers)
- [httpVersion](node_https_.IncomingMessage.md#httpversion)
- [httpVersionMajor](node_https_.IncomingMessage.md#httpversionmajor)
- [httpVersionMinor](node_https_.IncomingMessage.md#httpversionminor)
- [locked](node_https_.IncomingMessage.md#locked)
- [method](node_https_.IncomingMessage.md#method)
- [rawHeaders](node_https_.IncomingMessage.md#rawheaders)
- [rawTrailers](node_https_.IncomingMessage.md#rawtrailers)
- [readable](node_https_.IncomingMessage.md#readable)
- [readableAborted](node_https_.IncomingMessage.md#readableaborted)
- [readableEncoding](node_https_.IncomingMessage.md#readableencoding)
- [readableEnded](node_https_.IncomingMessage.md#readableended)
- [readableFlowing](node_https_.IncomingMessage.md#readableflowing)
- [readableHighWaterMark](node_https_.IncomingMessage.md#readablehighwatermark)
- [readableLength](node_https_.IncomingMessage.md#readablelength)
- [readableObjectMode](node_https_.IncomingMessage.md#readableobjectmode)
- [statusCode](node_https_.IncomingMessage.md#statuscode)
- [statusMessage](node_https_.IncomingMessage.md#statusmessage)
- [trailers](node_https_.IncomingMessage.md#trailers)
- [url](node_https_.IncomingMessage.md#url)
- [captureRejectionSymbol](node_https_.IncomingMessage.md#capturerejectionsymbol)
- [captureRejections](node_https_.IncomingMessage.md#capturerejections)
- [defaultMaxListeners](node_https_.IncomingMessage.md#defaultmaxlisteners)
- [errorMonitor](node_https_.IncomingMessage.md#errormonitor)

### Methods

- [[asyncIterator]](node_https_.IncomingMessage.md#[asynciterator])
- [\_construct](node_https_.IncomingMessage.md#_construct)
- [\_destroy](node_https_.IncomingMessage.md#_destroy)
- [\_read](node_https_.IncomingMessage.md#_read)
- [addListener](node_https_.IncomingMessage.md#addlistener)
- [cancel](node_https_.IncomingMessage.md#cancel)
- [destroy](node_https_.IncomingMessage.md#destroy)
- [emit](node_https_.IncomingMessage.md#emit)
- [eventNames](node_https_.IncomingMessage.md#eventnames)
- [forEach](node_https_.IncomingMessage.md#foreach)
- [getMaxListeners](node_https_.IncomingMessage.md#getmaxlisteners)
- [getReader](node_https_.IncomingMessage.md#getreader)
- [isPaused](node_https_.IncomingMessage.md#ispaused)
- [listenerCount](node_https_.IncomingMessage.md#listenercount)
- [listeners](node_https_.IncomingMessage.md#listeners)
- [off](node_https_.IncomingMessage.md#off)
- [on](node_https_.IncomingMessage.md#on)
- [once](node_https_.IncomingMessage.md#once)
- [pause](node_https_.IncomingMessage.md#pause)
- [pipe](node_https_.IncomingMessage.md#pipe)
- [pipeThrough](node_https_.IncomingMessage.md#pipethrough)
- [pipeTo](node_https_.IncomingMessage.md#pipeto)
- [prependListener](node_https_.IncomingMessage.md#prependlistener)
- [prependOnceListener](node_https_.IncomingMessage.md#prependoncelistener)
- [push](node_https_.IncomingMessage.md#push)
- [rawListeners](node_https_.IncomingMessage.md#rawlisteners)
- [read](node_https_.IncomingMessage.md#read)
- [removeAllListeners](node_https_.IncomingMessage.md#removealllisteners)
- [removeListener](node_https_.IncomingMessage.md#removelistener)
- [resume](node_https_.IncomingMessage.md#resume)
- [setEncoding](node_https_.IncomingMessage.md#setencoding)
- [setMaxListeners](node_https_.IncomingMessage.md#setmaxlisteners)
- [setTimeout](node_https_.IncomingMessage.md#settimeout)
- [tee](node_https_.IncomingMessage.md#tee)
- [unpipe](node_https_.IncomingMessage.md#unpipe)
- [unshift](node_https_.IncomingMessage.md#unshift)
- [wrap](node_https_.IncomingMessage.md#wrap)
- [from](node_https_.IncomingMessage.md#from)
- [getEventListeners](node_https_.IncomingMessage.md#geteventlisteners)
- [isDisturbed](node_https_.IncomingMessage.md#isdisturbed)
- [listenerCount](node_https_.IncomingMessage.md#listenercount-1)
- [on](node_https_.IncomingMessage.md#on-1)
- [once](node_https_.IncomingMessage.md#once-1)
- [setMaxListeners](node_https_.IncomingMessage.md#setmaxlisteners-1)
...
**Only valid for response obtained from [ClientRequest](node_https_.ClientRequest.md).**
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_https_.IncomingMessage.md#defaultmaxlisteners).
...
Calling [read](node_https_.IncomingMessage.md#read) after the `'end'` event has
...
using the [pipe](node_https_.IncomingMessage.md#pipe) method.
...
Unlike [push](node_https_.IncomingMessage.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_https_.IncomingMessage.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_https_.IncomingMessage.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](node_https_.IncomingMessage.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
