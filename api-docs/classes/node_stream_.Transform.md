[bun-types](../README.md) / [Exports](../modules.md) / ["node:stream"](../modules/node_stream_.md) / Transform

# Class: Transform

["node:stream"](../modules/node_stream_.md).Transform
...
- [constructor](node_stream_.Transform.md#constructor)

### Properties

- [allowHalfOpen](node_stream_.Transform.md#allowhalfopen)
- [destroyed](node_stream_.Transform.md#destroyed)
- [locked](node_stream_.Transform.md#locked)
- [readable](node_stream_.Transform.md#readable)
- [readableAborted](node_stream_.Transform.md#readableaborted)
- [readableEncoding](node_stream_.Transform.md#readableencoding)
- [readableEnded](node_stream_.Transform.md#readableended)
- [readableFlowing](node_stream_.Transform.md#readableflowing)
- [readableHighWaterMark](node_stream_.Transform.md#readablehighwatermark)
- [readableLength](node_stream_.Transform.md#readablelength)
- [readableObjectMode](node_stream_.Transform.md#readableobjectmode)
- [writable](node_stream_.Transform.md#writable)
- [writableCorked](node_stream_.Transform.md#writablecorked)
- [writableEnded](node_stream_.Transform.md#writableended)
- [writableFinished](node_stream_.Transform.md#writablefinished)
- [writableHighWaterMark](node_stream_.Transform.md#writablehighwatermark)
- [writableLength](node_stream_.Transform.md#writablelength)
- [writableObjectMode](node_stream_.Transform.md#writableobjectmode)
- [captureRejectionSymbol](node_stream_.Transform.md#capturerejectionsymbol)
- [captureRejections](node_stream_.Transform.md#capturerejections)
- [defaultMaxListeners](node_stream_.Transform.md#defaultmaxlisteners)
- [errorMonitor](node_stream_.Transform.md#errormonitor)

### Methods

- [[asyncIterator]](node_stream_.Transform.md#[asynciterator])
- [\_construct](node_stream_.Transform.md#_construct)
- [\_destroy](node_stream_.Transform.md#_destroy)
- [\_final](node_stream_.Transform.md#_final)
- [\_flush](node_stream_.Transform.md#_flush)
- [\_read](node_stream_.Transform.md#_read)
- [\_transform](node_stream_.Transform.md#_transform)
- [\_write](node_stream_.Transform.md#_write)
- [\_writev](node_stream_.Transform.md#_writev)
- [abort](node_stream_.Transform.md#abort)
- [addListener](node_stream_.Transform.md#addlistener)
- [cancel](node_stream_.Transform.md#cancel)
- [close](node_stream_.Transform.md#close)
- [cork](node_stream_.Transform.md#cork)
- [destroy](node_stream_.Transform.md#destroy)
- [emit](node_stream_.Transform.md#emit)
- [end](node_stream_.Transform.md#end)
- [eventNames](node_stream_.Transform.md#eventnames)
- [forEach](node_stream_.Transform.md#foreach)
- [getMaxListeners](node_stream_.Transform.md#getmaxlisteners)
- [getReader](node_stream_.Transform.md#getreader)
- [getWriter](node_stream_.Transform.md#getwriter)
- [isPaused](node_stream_.Transform.md#ispaused)
- [listenerCount](node_stream_.Transform.md#listenercount)
- [listeners](node_stream_.Transform.md#listeners)
- [off](node_stream_.Transform.md#off)
- [on](node_stream_.Transform.md#on)
- [once](node_stream_.Transform.md#once)
- [pause](node_stream_.Transform.md#pause)
- [pipe](node_stream_.Transform.md#pipe)
- [pipeThrough](node_stream_.Transform.md#pipethrough)
- [pipeTo](node_stream_.Transform.md#pipeto)
- [prependListener](node_stream_.Transform.md#prependlistener)
- [prependOnceListener](node_stream_.Transform.md#prependoncelistener)
- [push](node_stream_.Transform.md#push)
- [rawListeners](node_stream_.Transform.md#rawlisteners)
- [read](node_stream_.Transform.md#read)
- [removeAllListeners](node_stream_.Transform.md#removealllisteners)
- [removeListener](node_stream_.Transform.md#removelistener)
- [resume](node_stream_.Transform.md#resume)
- [setDefaultEncoding](node_stream_.Transform.md#setdefaultencoding)
- [setEncoding](node_stream_.Transform.md#setencoding)
- [setMaxListeners](node_stream_.Transform.md#setmaxlisteners)
- [tee](node_stream_.Transform.md#tee)
- [uncork](node_stream_.Transform.md#uncork)
- [unpipe](node_stream_.Transform.md#unpipe)
- [unshift](node_stream_.Transform.md#unshift)
- [wrap](node_stream_.Transform.md#wrap)
- [write](node_stream_.Transform.md#write)
- [from](node_stream_.Transform.md#from)
- [getEventListeners](node_stream_.Transform.md#geteventlisteners)
- [isDisturbed](node_stream_.Transform.md#isdisturbed)
- [listenerCount](node_stream_.Transform.md#listenercount-1)
- [on](node_stream_.Transform.md#on-1)
- [once](node_stream_.Transform.md#once-1)
- [setMaxListeners](node_stream_.Transform.md#setmaxlisteners-1)
...
| Name | Type |
| :------ | :------ |
| `opts?` | [`TransformOptions`](../interfaces/stream_.TransformOptions.md) |

#### Overrides

[Duplex](stream_.Duplex.md).[constructor](stream_.Duplex.md#constructor)

#### Defined in

[stream.d.ts:981](https://github.com/valgaze/bun-types/blob/5e53f27/stream.d.ts#L981)
...
[Duplex](stream_.Duplex.md).[allowHalfOpen](stream_.Duplex.md#allowhalfopen)
...
[Duplex](stream_.Duplex.md).[destroyed](stream_.Duplex.md#destroyed)
...
[Duplex](stream_.Duplex.md).[locked](stream_.Duplex.md#locked)
...
[Duplex](stream_.Duplex.md).[readable](stream_.Duplex.md#readable)
...
[Duplex](stream_.Duplex.md).[readableAborted](stream_.Duplex.md#readableaborted)
...
[Duplex](stream_.Duplex.md).[readableEncoding](stream_.Duplex.md#readableencoding)
...
[Duplex](stream_.Duplex.md).[readableEnded](stream_.Duplex.md#readableended)
...
[Duplex](stream_.Duplex.md).[readableFlowing](stream_.Duplex.md#readableflowing)
...
[Duplex](stream_.Duplex.md).[readableHighWaterMark](stream_.Duplex.md#readablehighwatermark)
...
[Duplex](stream_.Duplex.md).[readableLength](stream_.Duplex.md#readablelength)
...
[Duplex](stream_.Duplex.md).[readableObjectMode](stream_.Duplex.md#readableobjectmode)
...
[Duplex](stream_.Duplex.md).[writable](stream_.Duplex.md#writable)
...
[Duplex](stream_.Duplex.md).[writableCorked](stream_.Duplex.md#writablecorked)
...
[Duplex](stream_.Duplex.md).[writableEnded](stream_.Duplex.md#writableended)
...
[Duplex](stream_.Duplex.md).[writableFinished](stream_.Duplex.md#writablefinished)
...
[Duplex](stream_.Duplex.md).[writableHighWaterMark](stream_.Duplex.md#writablehighwatermark)
...
[Duplex](stream_.Duplex.md).[writableLength](stream_.Duplex.md#writablelength)
...
[Duplex](stream_.Duplex.md).[writableObjectMode](stream_.Duplex.md#writableobjectmode)
...
[Duplex](stream_.Duplex.md).[captureRejectionSymbol](stream_.Duplex.md#capturerejectionsymbol)
...
[Duplex](stream_.Duplex.md).[captureRejections](stream_.Duplex.md#capturerejections)
...
[Duplex](stream_.Duplex.md).[defaultMaxListeners](stream_.Duplex.md#defaultmaxlisteners)
...
[Duplex](stream_.Duplex.md).[errorMonitor](stream_.Duplex.md#errormonitor)
...
[Duplex](stream_.Duplex.md).[[asyncIterator]](stream_.Duplex.md#[asynciterator])
...
[Duplex](stream_.Duplex.md).[_construct](stream_.Duplex.md#_construct)
...
[Duplex](stream_.Duplex.md).[_destroy](stream_.Duplex.md#_destroy)
...
[Duplex](stream_.Duplex.md).[_final](stream_.Duplex.md#_final)
...
[Duplex](stream_.Duplex.md).[_read](stream_.Duplex.md#_read)
...
[Duplex](stream_.Duplex.md).[_write](stream_.Duplex.md#_write)
...
[Duplex](stream_.Duplex.md).[_writev](stream_.Duplex.md#_writev)
...
[Duplex](stream_.Duplex.md).[abort](stream_.Duplex.md#abort)
...
▸ **addListener**(`event`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[addListener](stream_.Duplex.md#addlistener)
...
[Duplex](stream_.Duplex.md).[cancel](stream_.Duplex.md#cancel)
...
[Duplex](stream_.Duplex.md).[close](stream_.Duplex.md#close)
...
The buffered data will be flushed when either the [uncork](node_stream_.Transform.md#uncork) or [end](node_stream_.Transform.md#end) methods are called.
...
[Duplex](stream_.Duplex.md).[cork](stream_.Duplex.md#cork)
...
▸ **destroy**(`error?`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[destroy](stream_.Duplex.md#destroy)
...
[Duplex](stream_.Duplex.md).[emit](stream_.Duplex.md#emit)
...
▸ **end**(`cb?`): [`Transform`](stream_.Transform.md)
...
Calling the [write](node_stream_.Transform.md#write) method after calling [end](node_stream_.Transform.md#end) will raise an error.
...
[Duplex](stream_.Duplex.md).[end](stream_.Duplex.md#end)

#### Defined in

[stream.d.ts:928](https://github.com/valgaze/bun-types/blob/5e53f27/stream.d.ts#L928)

▸ **end**(`chunk`, `cb?`): [`Transform`](stream_.Transform.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[eventNames](stream_.Duplex.md#eventnames)
...
[Duplex](stream_.Duplex.md).[forEach](stream_.Duplex.md#foreach)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_stream_.Transform.md#defaultmaxlisteners).
...
[Duplex](stream_.Duplex.md).[getMaxListeners](stream_.Duplex.md#getmaxlisteners)
...
[Duplex](stream_.Duplex.md).[getReader](stream_.Duplex.md#getreader)
...
[Duplex](stream_.Duplex.md).[getWriter](stream_.Duplex.md#getwriter)
...
[Duplex](stream_.Duplex.md).[isPaused](stream_.Duplex.md#ispaused)
...
[Duplex](stream_.Duplex.md).[listenerCount](stream_.Duplex.md#listenercount)
...
[Duplex](stream_.Duplex.md).[listeners](stream_.Duplex.md#listeners)
...
▸ **off**(`eventName`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[off](stream_.Duplex.md#off)
...
▸ **on**(`event`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[on](stream_.Duplex.md#on)
...
▸ **once**(`event`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[once](stream_.Duplex.md#once)
...
▸ **pause**(): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[pause](stream_.Duplex.md#pause)
...
[Duplex](stream_.Duplex.md).[pipe](stream_.Duplex.md#pipe)
...
[Duplex](stream_.Duplex.md).[pipeThrough](stream_.Duplex.md#pipethrough)
...
[Duplex](stream_.Duplex.md).[pipeTo](stream_.Duplex.md#pipeto)
...
▸ **prependListener**(`event`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[prependListener](stream_.Duplex.md#prependlistener)
...
▸ **prependOnceListener**(`event`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[prependOnceListener](stream_.Duplex.md#prependoncelistener)
...
[Duplex](stream_.Duplex.md).[push](stream_.Duplex.md#push)
...
[Duplex](stream_.Duplex.md).[rawListeners](stream_.Duplex.md#rawlisteners)
...
Calling [read](node_stream_.Transform.md#read) after the `'end'` event has
...
[Duplex](stream_.Duplex.md).[read](stream_.Duplex.md#read)
...
▸ **removeAllListeners**(`event?`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[removeAllListeners](stream_.Duplex.md#removealllisteners)
...
▸ **removeListener**(`event`, `listener`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[removeListener](stream_.Duplex.md#removelistener)
...
▸ **resume**(): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[resume](stream_.Duplex.md#resume)
...
▸ **setDefaultEncoding**(`encoding`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[setDefaultEncoding](stream_.Duplex.md#setdefaultencoding)
...
▸ **setEncoding**(`encoding`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[setEncoding](stream_.Duplex.md#setencoding)
...
▸ **setMaxListeners**(`n`): [`Transform`](stream_.Transform.md)
...
[Duplex](stream_.Duplex.md).[setMaxListeners](stream_.Duplex.md#setmaxlisteners)
...
[Duplex](stream_.Duplex.md).[tee](stream_.Duplex.md#tee)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_stream_.Transform.md#cork) was called.
...
[Duplex](stream_.Duplex.md).[uncork](stream_.Duplex.md#uncork)
...
▸ **unpipe**(`destination?`): [`Transform`](stream_.Transform.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_stream_.Transform.md#pipe) method.
...
[Duplex](stream_.Duplex.md).[unpipe](stream_.Duplex.md#unpipe)
...
Unlike [push](node_stream_.Transform.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_stream_.Transform.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_stream_.Transform.md#push) will reset the reading state appropriately,
...
[Duplex](stream_.Duplex.md).[unshift](stream_.Duplex.md#unshift)
...
▸ **wrap**(`stream`): [`Transform`](stream_.Transform.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_stream_.Transform.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
[Duplex](stream_.Duplex.md).[wrap](stream_.Duplex.md#wrap)
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_stream_.Transform.md#pipe). However, if calling `write()` is preferred, it is
...
[Duplex](stream_.Duplex.md).[write](stream_.Duplex.md#write)
...
[Duplex](stream_.Duplex.md).[from](stream_.Duplex.md#from)
...
[Duplex](stream_.Duplex.md).[getEventListeners](stream_.Duplex.md#geteventlisteners)
...
[Duplex](stream_.Duplex.md).[isDisturbed](stream_.Duplex.md#isdisturbed)
...
[Duplex](stream_.Duplex.md).[listenerCount](stream_.Duplex.md#listenercount-1)
...
[Duplex](stream_.Duplex.md).[on](stream_.Duplex.md#on-1)
...
[Duplex](stream_.Duplex.md).[once](stream_.Duplex.md#once-1)
...
[Duplex](stream_.Duplex.md).[setMaxListeners](stream_.Duplex.md#setmaxlisteners-1)
