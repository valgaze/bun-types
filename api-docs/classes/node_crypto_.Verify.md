[bun-types](../README.md) / [Exports](../modules.md) / ["node:crypto"](../modules/node_crypto_.md) / Verify

# Class: Verify

["node:crypto"](../modules/node_crypto_.md).Verify
...
The [createVerify](../modules/node_crypto_.md#createverify) method is used to create `Verify` instances.`Verify` objects are not to be created directly using the `new` keyword.
...
- [constructor](node_crypto_.Verify.md#constructor)

### Properties

- [destroyed](node_crypto_.Verify.md#destroyed)
- [locked](node_crypto_.Verify.md#locked)
- [writable](node_crypto_.Verify.md#writable)
- [writableCorked](node_crypto_.Verify.md#writablecorked)
- [writableEnded](node_crypto_.Verify.md#writableended)
- [writableFinished](node_crypto_.Verify.md#writablefinished)
- [writableHighWaterMark](node_crypto_.Verify.md#writablehighwatermark)
- [writableLength](node_crypto_.Verify.md#writablelength)
- [writableObjectMode](node_crypto_.Verify.md#writableobjectmode)
- [captureRejectionSymbol](node_crypto_.Verify.md#capturerejectionsymbol)
- [captureRejections](node_crypto_.Verify.md#capturerejections)
- [defaultMaxListeners](node_crypto_.Verify.md#defaultmaxlisteners)
- [errorMonitor](node_crypto_.Verify.md#errormonitor)

### Methods

- [\_construct](node_crypto_.Verify.md#_construct)
- [\_destroy](node_crypto_.Verify.md#_destroy)
- [\_final](node_crypto_.Verify.md#_final)
- [\_write](node_crypto_.Verify.md#_write)
- [\_writev](node_crypto_.Verify.md#_writev)
- [abort](node_crypto_.Verify.md#abort)
- [addListener](node_crypto_.Verify.md#addlistener)
- [close](node_crypto_.Verify.md#close)
- [cork](node_crypto_.Verify.md#cork)
- [destroy](node_crypto_.Verify.md#destroy)
- [emit](node_crypto_.Verify.md#emit)
- [end](node_crypto_.Verify.md#end)
- [eventNames](node_crypto_.Verify.md#eventnames)
- [getMaxListeners](node_crypto_.Verify.md#getmaxlisteners)
- [getWriter](node_crypto_.Verify.md#getwriter)
- [listenerCount](node_crypto_.Verify.md#listenercount)
- [listeners](node_crypto_.Verify.md#listeners)
- [off](node_crypto_.Verify.md#off)
- [on](node_crypto_.Verify.md#on)
- [once](node_crypto_.Verify.md#once)
- [pipe](node_crypto_.Verify.md#pipe)
- [prependListener](node_crypto_.Verify.md#prependlistener)
- [prependOnceListener](node_crypto_.Verify.md#prependoncelistener)
- [rawListeners](node_crypto_.Verify.md#rawlisteners)
- [removeAllListeners](node_crypto_.Verify.md#removealllisteners)
- [removeListener](node_crypto_.Verify.md#removelistener)
- [setDefaultEncoding](node_crypto_.Verify.md#setdefaultencoding)
- [setMaxListeners](node_crypto_.Verify.md#setmaxlisteners)
- [uncork](node_crypto_.Verify.md#uncork)
- [update](node_crypto_.Verify.md#update)
- [verify](node_crypto_.Verify.md#verify)
- [write](node_crypto_.Verify.md#write)
- [getEventListeners](node_crypto_.Verify.md#geteventlisteners)
- [listenerCount](node_crypto_.Verify.md#listenercount-1)
- [on](node_crypto_.Verify.md#on-1)
- [once](node_crypto_.Verify.md#once-1)
- [setMaxListeners](node_crypto_.Verify.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](node_crypto_.Verify.md#uncork) or [end](node_crypto_.Verify.md#end) methods are called.
...
Calling the [write](node_crypto_.Verify.md#write) method after calling [end](node_crypto_.Verify.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_crypto_.Verify.md#defaultmaxlisteners).
...
The `writable.uncork()` method flushes all data buffered since [cork](node_crypto_.Verify.md#cork) was called.
...
If `object` is not a `KeyObject`, this function behaves as if`object` had been passed to [createPublicKey](../modules/node_crypto_.md#createpublickey). If it is an
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_crypto_.Verify.md#pipe). However, if calling `write()` is preferred, it is
