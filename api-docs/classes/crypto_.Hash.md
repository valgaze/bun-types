[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / Hash

# Class: Hash

["crypto"](../modules/crypto_.md).Hash
...
The [createHash](../modules/crypto_.md#createhash) method is used to create `Hash` instances. `Hash`objects are not to be created directly using the `new` keyword.
...
- [constructor](crypto_.Hash.md#constructor)

### Properties

- [allowHalfOpen](crypto_.Hash.md#allowhalfopen)
- [destroyed](crypto_.Hash.md#destroyed)
- [locked](crypto_.Hash.md#locked)
- [readable](crypto_.Hash.md#readable)
- [readableAborted](crypto_.Hash.md#readableaborted)
- [readableEncoding](crypto_.Hash.md#readableencoding)
- [readableEnded](crypto_.Hash.md#readableended)
- [readableFlowing](crypto_.Hash.md#readableflowing)
- [readableHighWaterMark](crypto_.Hash.md#readablehighwatermark)
- [readableLength](crypto_.Hash.md#readablelength)
- [readableObjectMode](crypto_.Hash.md#readableobjectmode)
- [writable](crypto_.Hash.md#writable)
- [writableCorked](crypto_.Hash.md#writablecorked)
- [writableEnded](crypto_.Hash.md#writableended)
- [writableFinished](crypto_.Hash.md#writablefinished)
- [writableHighWaterMark](crypto_.Hash.md#writablehighwatermark)
- [writableLength](crypto_.Hash.md#writablelength)
- [writableObjectMode](crypto_.Hash.md#writableobjectmode)
- [captureRejectionSymbol](crypto_.Hash.md#capturerejectionsymbol)
- [captureRejections](crypto_.Hash.md#capturerejections)
- [defaultMaxListeners](crypto_.Hash.md#defaultmaxlisteners)
- [errorMonitor](crypto_.Hash.md#errormonitor)

### Methods

- [[asyncIterator]](crypto_.Hash.md#[asynciterator])
- [\_construct](crypto_.Hash.md#_construct)
- [\_destroy](crypto_.Hash.md#_destroy)
- [\_final](crypto_.Hash.md#_final)
- [\_flush](crypto_.Hash.md#_flush)
- [\_read](crypto_.Hash.md#_read)
- [\_transform](crypto_.Hash.md#_transform)
- [\_write](crypto_.Hash.md#_write)
- [\_writev](crypto_.Hash.md#_writev)
- [abort](crypto_.Hash.md#abort)
- [addListener](crypto_.Hash.md#addlistener)
- [cancel](crypto_.Hash.md#cancel)
- [close](crypto_.Hash.md#close)
- [copy](crypto_.Hash.md#copy)
- [cork](crypto_.Hash.md#cork)
- [destroy](crypto_.Hash.md#destroy)
- [digest](crypto_.Hash.md#digest)
- [emit](crypto_.Hash.md#emit)
- [end](crypto_.Hash.md#end)
- [eventNames](crypto_.Hash.md#eventnames)
- [forEach](crypto_.Hash.md#foreach)
- [getMaxListeners](crypto_.Hash.md#getmaxlisteners)
- [getReader](crypto_.Hash.md#getreader)
- [getWriter](crypto_.Hash.md#getwriter)
- [isPaused](crypto_.Hash.md#ispaused)
- [listenerCount](crypto_.Hash.md#listenercount)
- [listeners](crypto_.Hash.md#listeners)
- [off](crypto_.Hash.md#off)
- [on](crypto_.Hash.md#on)
- [once](crypto_.Hash.md#once)
- [pause](crypto_.Hash.md#pause)
- [pipe](crypto_.Hash.md#pipe)
- [pipeThrough](crypto_.Hash.md#pipethrough)
- [pipeTo](crypto_.Hash.md#pipeto)
- [prependListener](crypto_.Hash.md#prependlistener)
- [prependOnceListener](crypto_.Hash.md#prependoncelistener)
- [push](crypto_.Hash.md#push)
- [rawListeners](crypto_.Hash.md#rawlisteners)
- [read](crypto_.Hash.md#read)
- [removeAllListeners](crypto_.Hash.md#removealllisteners)
- [removeListener](crypto_.Hash.md#removelistener)
- [resume](crypto_.Hash.md#resume)
- [setDefaultEncoding](crypto_.Hash.md#setdefaultencoding)
- [setEncoding](crypto_.Hash.md#setencoding)
- [setMaxListeners](crypto_.Hash.md#setmaxlisteners)
- [tee](crypto_.Hash.md#tee)
- [uncork](crypto_.Hash.md#uncork)
- [unpipe](crypto_.Hash.md#unpipe)
- [unshift](crypto_.Hash.md#unshift)
- [update](crypto_.Hash.md#update)
- [wrap](crypto_.Hash.md#wrap)
- [write](crypto_.Hash.md#write)
- [from](crypto_.Hash.md#from)
- [getEventListeners](crypto_.Hash.md#geteventlisteners)
- [isDisturbed](crypto_.Hash.md#isdisturbed)
- [listenerCount](crypto_.Hash.md#listenercount-1)
- [on](crypto_.Hash.md#on-1)
- [once](crypto_.Hash.md#once-1)
- [setMaxListeners](crypto_.Hash.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto_.Hash.md#uncork) or [end](crypto_.Hash.md#end) methods are called.
...
Calling the [write](crypto_.Hash.md#write) method after calling [end](crypto_.Hash.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto_.Hash.md#defaultmaxlisteners).
...
Calling [read](crypto_.Hash.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.Hash.md#cork) was called.
...
using the [pipe](crypto_.Hash.md#pipe) method.
...
Unlike [push](crypto_.Hash.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.Hash.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.Hash.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.Hash.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.Hash.md#pipe). However, if calling `write()` is preferred, it is
