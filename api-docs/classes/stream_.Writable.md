[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](../modules/stream_.md) / Writable

# Class: Writable<W\>

["stream"](../modules/stream_.md).Writable
...
- [`Stream`](stream_.Stream.md)
  ...
  ↳↳ [`Sign`](crypto_.Sign.md)

  ↳↳ [`Verify`](crypto_.Verify.md)

  ↳↳ [`Sign`](node_crypto_.Sign.md)

  ↳↳ [`Verify`](node_crypto_.Verify.md)
...
- [constructor](stream_.Writable.md#constructor)

### Properties

- [destroyed](stream_.Writable.md#destroyed)
- [locked](stream_.Writable.md#locked)
- [writable](stream_.Writable.md#writable)
- [writableCorked](stream_.Writable.md#writablecorked)
- [writableEnded](stream_.Writable.md#writableended)
- [writableFinished](stream_.Writable.md#writablefinished)
- [writableHighWaterMark](stream_.Writable.md#writablehighwatermark)
- [writableLength](stream_.Writable.md#writablelength)
- [writableObjectMode](stream_.Writable.md#writableobjectmode)
- [captureRejectionSymbol](stream_.Writable.md#capturerejectionsymbol)
- [captureRejections](stream_.Writable.md#capturerejections)
- [defaultMaxListeners](stream_.Writable.md#defaultmaxlisteners)
- [errorMonitor](stream_.Writable.md#errormonitor)

### Methods

- [\_construct](stream_.Writable.md#_construct)
- [\_destroy](stream_.Writable.md#_destroy)
- [\_final](stream_.Writable.md#_final)
- [\_write](stream_.Writable.md#_write)
- [\_writev](stream_.Writable.md#_writev)
- [abort](stream_.Writable.md#abort)
- [addListener](stream_.Writable.md#addlistener)
- [close](stream_.Writable.md#close)
- [cork](stream_.Writable.md#cork)
- [destroy](stream_.Writable.md#destroy)
- [emit](stream_.Writable.md#emit)
- [end](stream_.Writable.md#end)
- [eventNames](stream_.Writable.md#eventnames)
- [getMaxListeners](stream_.Writable.md#getmaxlisteners)
- [getWriter](stream_.Writable.md#getwriter)
- [listenerCount](stream_.Writable.md#listenercount)
- [listeners](stream_.Writable.md#listeners)
- [off](stream_.Writable.md#off)
- [on](stream_.Writable.md#on)
- [once](stream_.Writable.md#once)
- [pipe](stream_.Writable.md#pipe)
- [prependListener](stream_.Writable.md#prependlistener)
- [prependOnceListener](stream_.Writable.md#prependoncelistener)
- [rawListeners](stream_.Writable.md#rawlisteners)
- [removeAllListeners](stream_.Writable.md#removealllisteners)
- [removeListener](stream_.Writable.md#removelistener)
- [setDefaultEncoding](stream_.Writable.md#setdefaultencoding)
- [setMaxListeners](stream_.Writable.md#setmaxlisteners)
- [uncork](stream_.Writable.md#uncork)
- [write](stream_.Writable.md#write)
- [getEventListeners](stream_.Writable.md#geteventlisteners)
- [listenerCount](stream_.Writable.md#listenercount-1)
- [on](stream_.Writable.md#on-1)
- [once](stream_.Writable.md#once-1)
- [setMaxListeners](stream_.Writable.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](stream_.Writable.md#uncork) or [end](stream_.Writable.md#end) methods are called.
...
Calling the [write](stream_.Writable.md#write) method after calling [end](stream_.Writable.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream_.Writable.md#defaultmaxlisteners).
...
The `writable.uncork()` method flushes all data buffered since [cork](stream_.Writable.md#cork) was called.
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream_.Writable.md#pipe). However, if calling `write()` is preferred, it is
