[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / Decipher

# Class: Decipher

["crypto"](../modules/crypto_.md).Decipher
...
- [constructor](crypto_.Decipher.md#constructor)

### Properties

- [allowHalfOpen](crypto_.Decipher.md#allowhalfopen)
- [destroyed](crypto_.Decipher.md#destroyed)
- [locked](crypto_.Decipher.md#locked)
- [readable](crypto_.Decipher.md#readable)
- [readableAborted](crypto_.Decipher.md#readableaborted)
- [readableEncoding](crypto_.Decipher.md#readableencoding)
- [readableEnded](crypto_.Decipher.md#readableended)
- [readableFlowing](crypto_.Decipher.md#readableflowing)
- [readableHighWaterMark](crypto_.Decipher.md#readablehighwatermark)
- [readableLength](crypto_.Decipher.md#readablelength)
- [readableObjectMode](crypto_.Decipher.md#readableobjectmode)
- [writable](crypto_.Decipher.md#writable)
- [writableCorked](crypto_.Decipher.md#writablecorked)
- [writableEnded](crypto_.Decipher.md#writableended)
- [writableFinished](crypto_.Decipher.md#writablefinished)
- [writableHighWaterMark](crypto_.Decipher.md#writablehighwatermark)
- [writableLength](crypto_.Decipher.md#writablelength)
- [writableObjectMode](crypto_.Decipher.md#writableobjectmode)
- [captureRejectionSymbol](crypto_.Decipher.md#capturerejectionsymbol)
- [captureRejections](crypto_.Decipher.md#capturerejections)
- [defaultMaxListeners](crypto_.Decipher.md#defaultmaxlisteners)
- [errorMonitor](crypto_.Decipher.md#errormonitor)

### Methods

- [[asyncIterator]](crypto_.Decipher.md#[asynciterator])
- [\_construct](crypto_.Decipher.md#_construct)
- [\_destroy](crypto_.Decipher.md#_destroy)
- [\_final](crypto_.Decipher.md#_final)
- [\_flush](crypto_.Decipher.md#_flush)
- [\_read](crypto_.Decipher.md#_read)
- [\_transform](crypto_.Decipher.md#_transform)
- [\_write](crypto_.Decipher.md#_write)
- [\_writev](crypto_.Decipher.md#_writev)
- [abort](crypto_.Decipher.md#abort)
- [addListener](crypto_.Decipher.md#addlistener)
- [cancel](crypto_.Decipher.md#cancel)
- [close](crypto_.Decipher.md#close)
- [cork](crypto_.Decipher.md#cork)
- [destroy](crypto_.Decipher.md#destroy)
- [emit](crypto_.Decipher.md#emit)
- [end](crypto_.Decipher.md#end)
- [eventNames](crypto_.Decipher.md#eventnames)
- [final](crypto_.Decipher.md#final)
- [forEach](crypto_.Decipher.md#foreach)
- [getMaxListeners](crypto_.Decipher.md#getmaxlisteners)
- [getReader](crypto_.Decipher.md#getreader)
- [getWriter](crypto_.Decipher.md#getwriter)
- [isPaused](crypto_.Decipher.md#ispaused)
- [listenerCount](crypto_.Decipher.md#listenercount)
- [listeners](crypto_.Decipher.md#listeners)
- [off](crypto_.Decipher.md#off)
- [on](crypto_.Decipher.md#on)
- [once](crypto_.Decipher.md#once)
- [pause](crypto_.Decipher.md#pause)
- [pipe](crypto_.Decipher.md#pipe)
- [pipeThrough](crypto_.Decipher.md#pipethrough)
- [pipeTo](crypto_.Decipher.md#pipeto)
- [prependListener](crypto_.Decipher.md#prependlistener)
- [prependOnceListener](crypto_.Decipher.md#prependoncelistener)
- [push](crypto_.Decipher.md#push)
- [rawListeners](crypto_.Decipher.md#rawlisteners)
- [read](crypto_.Decipher.md#read)
- [removeAllListeners](crypto_.Decipher.md#removealllisteners)
- [removeListener](crypto_.Decipher.md#removelistener)
- [resume](crypto_.Decipher.md#resume)
- [setAutoPadding](crypto_.Decipher.md#setautopadding)
- [setDefaultEncoding](crypto_.Decipher.md#setdefaultencoding)
- [setEncoding](crypto_.Decipher.md#setencoding)
- [setMaxListeners](crypto_.Decipher.md#setmaxlisteners)
- [tee](crypto_.Decipher.md#tee)
- [uncork](crypto_.Decipher.md#uncork)
- [unpipe](crypto_.Decipher.md#unpipe)
- [unshift](crypto_.Decipher.md#unshift)
- [update](crypto_.Decipher.md#update)
- [wrap](crypto_.Decipher.md#wrap)
- [write](crypto_.Decipher.md#write)
- [from](crypto_.Decipher.md#from)
- [getEventListeners](crypto_.Decipher.md#geteventlisteners)
- [isDisturbed](crypto_.Decipher.md#isdisturbed)
- [listenerCount](crypto_.Decipher.md#listenercount-1)
- [on](crypto_.Decipher.md#on-1)
- [once](crypto_.Decipher.md#once-1)
- [setMaxListeners](crypto_.Decipher.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto_.Decipher.md#uncork) or [end](crypto_.Decipher.md#end) methods are called.
...
Calling the [write](crypto_.Decipher.md#write) method after calling [end](crypto_.Decipher.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto_.Decipher.md#defaultmaxlisteners).
...
Calling [read](crypto_.Decipher.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.Decipher.md#cork) was called.
...
using the [pipe](crypto_.Decipher.md#pipe) method.
...
Unlike [push](crypto_.Decipher.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.Decipher.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.Decipher.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.Decipher.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.Decipher.md#pipe). However, if calling `write()` is preferred, it is
