[bun-types](../README.md) / [Exports](../modules.md) / ["node:stream"](../modules/node_stream_.md) / Readable

# Class: Readable<R\>

["node:stream"](../modules/node_stream_.md).Readable
...
- [constructor](node_stream_.Readable.md#constructor)

### Properties

- [destroyed](node_stream_.Readable.md#destroyed)
- [locked](node_stream_.Readable.md#locked)
- [readable](node_stream_.Readable.md#readable)
- [readableAborted](node_stream_.Readable.md#readableaborted)
- [readableEncoding](node_stream_.Readable.md#readableencoding)
- [readableEnded](node_stream_.Readable.md#readableended)
- [readableFlowing](node_stream_.Readable.md#readableflowing)
- [readableHighWaterMark](node_stream_.Readable.md#readablehighwatermark)
- [readableLength](node_stream_.Readable.md#readablelength)
- [readableObjectMode](node_stream_.Readable.md#readableobjectmode)
- [captureRejectionSymbol](node_stream_.Readable.md#capturerejectionsymbol)
- [captureRejections](node_stream_.Readable.md#capturerejections)
- [defaultMaxListeners](node_stream_.Readable.md#defaultmaxlisteners)
- [errorMonitor](node_stream_.Readable.md#errormonitor)

### Methods

- [[asyncIterator]](node_stream_.Readable.md#[asynciterator])
- [\_construct](node_stream_.Readable.md#_construct)
- [\_destroy](node_stream_.Readable.md#_destroy)
- [\_read](node_stream_.Readable.md#_read)
- [addListener](node_stream_.Readable.md#addlistener)
- [cancel](node_stream_.Readable.md#cancel)
- [destroy](node_stream_.Readable.md#destroy)
- [emit](node_stream_.Readable.md#emit)
- [eventNames](node_stream_.Readable.md#eventnames)
- [forEach](node_stream_.Readable.md#foreach)
- [getMaxListeners](node_stream_.Readable.md#getmaxlisteners)
- [getReader](node_stream_.Readable.md#getreader)
- [isPaused](node_stream_.Readable.md#ispaused)
- [listenerCount](node_stream_.Readable.md#listenercount)
- [listeners](node_stream_.Readable.md#listeners)
- [off](node_stream_.Readable.md#off)
- [on](node_stream_.Readable.md#on)
- [once](node_stream_.Readable.md#once)
- [pause](node_stream_.Readable.md#pause)
- [pipe](node_stream_.Readable.md#pipe)
- [pipeThrough](node_stream_.Readable.md#pipethrough)
- [pipeTo](node_stream_.Readable.md#pipeto)
- [prependListener](node_stream_.Readable.md#prependlistener)
- [prependOnceListener](node_stream_.Readable.md#prependoncelistener)
- [push](node_stream_.Readable.md#push)
- [rawListeners](node_stream_.Readable.md#rawlisteners)
- [read](node_stream_.Readable.md#read)
- [removeAllListeners](node_stream_.Readable.md#removealllisteners)
- [removeListener](node_stream_.Readable.md#removelistener)
- [resume](node_stream_.Readable.md#resume)
- [setEncoding](node_stream_.Readable.md#setencoding)
- [setMaxListeners](node_stream_.Readable.md#setmaxlisteners)
- [tee](node_stream_.Readable.md#tee)
- [unpipe](node_stream_.Readable.md#unpipe)
- [unshift](node_stream_.Readable.md#unshift)
- [wrap](node_stream_.Readable.md#wrap)
- [from](node_stream_.Readable.md#from)
- [getEventListeners](node_stream_.Readable.md#geteventlisteners)
- [isDisturbed](node_stream_.Readable.md#isdisturbed)
- [listenerCount](node_stream_.Readable.md#listenercount-1)
- [on](node_stream_.Readable.md#on-1)
- [once](node_stream_.Readable.md#once-1)
- [setMaxListeners](node_stream_.Readable.md#setmaxlisteners-1)
...
[Stream](stream_.Stream.md).[constructor](stream_.Stream.md#constructor)
...
[Stream](stream_.Stream.md).[captureRejectionSymbol](stream_.Stream.md#capturerejectionsymbol)
...
[Stream](stream_.Stream.md).[captureRejections](stream_.Stream.md#capturerejections)
...
[Stream](stream_.Stream.md).[defaultMaxListeners](stream_.Stream.md#defaultmaxlisteners)
...
[Stream](stream_.Stream.md).[errorMonitor](stream_.Stream.md#errormonitor)
...
▸ **addListener**(`event`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[`Readable`](stream_.Readable.md)<`R`\>

#### Overrides

[Stream](stream_.Stream.md).[addListener](stream_.Stream.md#addlistener)
...
▸ **destroy**(`error?`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[emit](stream_.Stream.md#emit)
...
[Stream](stream_.Stream.md).[eventNames](stream_.Stream.md#eventnames)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_stream_.Readable.md#defaultmaxlisteners).
...
[Stream](stream_.Stream.md).[getMaxListeners](stream_.Stream.md#getmaxlisteners)
...
[Stream](stream_.Stream.md).[listenerCount](stream_.Stream.md#listenercount)
...
[Stream](stream_.Stream.md).[listeners](stream_.Stream.md#listeners)
...
▸ **off**(`eventName`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[off](stream_.Stream.md#off)
...
▸ **on**(`event`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[on](stream_.Stream.md#on)
...
▸ **once**(`event`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[once](stream_.Stream.md#once)
...
▸ **pause**(): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[pipe](stream_.Stream.md#pipe)
...
| Name | Type |
| :------ | :------ |
| `transform` | [`ReadableWritablePair`](../interfaces/ReadableWritablePair.md)<`T`, `R`\> |
...
▸ **prependListener**(`event`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[prependListener](stream_.Stream.md#prependlistener)
...
▸ **prependOnceListener**(`event`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[prependOnceListener](stream_.Stream.md#prependoncelistener)
...
[Stream](stream_.Stream.md).[rawListeners](stream_.Stream.md#rawlisteners)
...
Calling [read](node_stream_.Readable.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[removeAllListeners](stream_.Stream.md#removealllisteners)
...
▸ **removeListener**(`event`, `listener`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[removeListener](stream_.Stream.md#removelistener)
...
▸ **resume**(): [`Readable`](stream_.Readable.md)<`R`\>
...
▸ **setEncoding**(`encoding`): [`Readable`](stream_.Readable.md)<`R`\>
...
▸ **setMaxListeners**(`n`): [`Readable`](stream_.Readable.md)<`R`\>
...
[Stream](stream_.Stream.md).[setMaxListeners](stream_.Stream.md#setmaxlisteners)
...
▸ **unpipe**(`destination?`): [`Readable`](stream_.Readable.md)<`R`\>

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_stream_.Readable.md#pipe) method.
...
Unlike [push](node_stream_.Readable.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_stream_.Readable.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_stream_.Readable.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`Readable`](stream_.Readable.md)<`R`\>

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_stream_.Readable.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
[Stream](stream_.Stream.md).[getEventListeners](stream_.Stream.md#geteventlisteners)
...
[Stream](stream_.Stream.md).[listenerCount](stream_.Stream.md#listenercount-1)
...
[Stream](stream_.Stream.md).[on](stream_.Stream.md#on-1)
...
[Stream](stream_.Stream.md).[once](stream_.Stream.md#once-1)
...
[Stream](stream_.Stream.md).[setMaxListeners](stream_.Stream.md#setmaxlisteners-1)
