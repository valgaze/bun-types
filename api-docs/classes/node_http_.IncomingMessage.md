[bun-types](../README.md) / [Exports](../modules.md) / ["node:http"](../modules/node_http_.md) / IncomingMessage

# Class: IncomingMessage

["node:http"](../modules/node_http_.md).IncomingMessage

An `IncomingMessage` object is created by Server or [ClientRequest](node_http_.ClientRequest.md) and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
...
- [constructor](node_http_.IncomingMessage.md#constructor)

### Properties

- [aborted](node_http_.IncomingMessage.md#aborted)
- [complete](node_http_.IncomingMessage.md#complete)
- [destroyed](node_http_.IncomingMessage.md#destroyed)
- [headers](node_http_.IncomingMessage.md#headers)
- [httpVersion](node_http_.IncomingMessage.md#httpversion)
- [httpVersionMajor](node_http_.IncomingMessage.md#httpversionmajor)
- [httpVersionMinor](node_http_.IncomingMessage.md#httpversionminor)
- [locked](node_http_.IncomingMessage.md#locked)
- [method](node_http_.IncomingMessage.md#method)
- [rawHeaders](node_http_.IncomingMessage.md#rawheaders)
- [rawTrailers](node_http_.IncomingMessage.md#rawtrailers)
- [readable](node_http_.IncomingMessage.md#readable)
- [readableAborted](node_http_.IncomingMessage.md#readableaborted)
- [readableEncoding](node_http_.IncomingMessage.md#readableencoding)
- [readableEnded](node_http_.IncomingMessage.md#readableended)
- [readableFlowing](node_http_.IncomingMessage.md#readableflowing)
- [readableHighWaterMark](node_http_.IncomingMessage.md#readablehighwatermark)
- [readableLength](node_http_.IncomingMessage.md#readablelength)
- [readableObjectMode](node_http_.IncomingMessage.md#readableobjectmode)
- [statusCode](node_http_.IncomingMessage.md#statuscode)
- [statusMessage](node_http_.IncomingMessage.md#statusmessage)
- [trailers](node_http_.IncomingMessage.md#trailers)
- [url](node_http_.IncomingMessage.md#url)
- [captureRejectionSymbol](node_http_.IncomingMessage.md#capturerejectionsymbol)
- [captureRejections](node_http_.IncomingMessage.md#capturerejections)
- [defaultMaxListeners](node_http_.IncomingMessage.md#defaultmaxlisteners)
- [errorMonitor](node_http_.IncomingMessage.md#errormonitor)

### Methods

- [[asyncIterator]](node_http_.IncomingMessage.md#[asynciterator])
- [\_construct](node_http_.IncomingMessage.md#_construct)
- [\_destroy](node_http_.IncomingMessage.md#_destroy)
- [\_read](node_http_.IncomingMessage.md#_read)
- [addListener](node_http_.IncomingMessage.md#addlistener)
- [cancel](node_http_.IncomingMessage.md#cancel)
- [destroy](node_http_.IncomingMessage.md#destroy)
- [emit](node_http_.IncomingMessage.md#emit)
- [eventNames](node_http_.IncomingMessage.md#eventnames)
- [forEach](node_http_.IncomingMessage.md#foreach)
- [getMaxListeners](node_http_.IncomingMessage.md#getmaxlisteners)
- [getReader](node_http_.IncomingMessage.md#getreader)
- [isPaused](node_http_.IncomingMessage.md#ispaused)
- [listenerCount](node_http_.IncomingMessage.md#listenercount)
- [listeners](node_http_.IncomingMessage.md#listeners)
- [off](node_http_.IncomingMessage.md#off)
- [on](node_http_.IncomingMessage.md#on)
- [once](node_http_.IncomingMessage.md#once)
- [pause](node_http_.IncomingMessage.md#pause)
- [pipe](node_http_.IncomingMessage.md#pipe)
- [pipeThrough](node_http_.IncomingMessage.md#pipethrough)
- [pipeTo](node_http_.IncomingMessage.md#pipeto)
- [prependListener](node_http_.IncomingMessage.md#prependlistener)
- [prependOnceListener](node_http_.IncomingMessage.md#prependoncelistener)
- [push](node_http_.IncomingMessage.md#push)
- [rawListeners](node_http_.IncomingMessage.md#rawlisteners)
- [read](node_http_.IncomingMessage.md#read)
- [removeAllListeners](node_http_.IncomingMessage.md#removealllisteners)
- [removeListener](node_http_.IncomingMessage.md#removelistener)
- [resume](node_http_.IncomingMessage.md#resume)
- [setEncoding](node_http_.IncomingMessage.md#setencoding)
- [setMaxListeners](node_http_.IncomingMessage.md#setmaxlisteners)
- [setTimeout](node_http_.IncomingMessage.md#settimeout)
- [tee](node_http_.IncomingMessage.md#tee)
- [unpipe](node_http_.IncomingMessage.md#unpipe)
- [unshift](node_http_.IncomingMessage.md#unshift)
- [wrap](node_http_.IncomingMessage.md#wrap)
- [from](node_http_.IncomingMessage.md#from)
- [getEventListeners](node_http_.IncomingMessage.md#geteventlisteners)
- [isDisturbed](node_http_.IncomingMessage.md#isdisturbed)
- [listenerCount](node_http_.IncomingMessage.md#listenercount-1)
- [on](node_http_.IncomingMessage.md#on-1)
- [once](node_http_.IncomingMessage.md#once-1)
- [setMaxListeners](node_http_.IncomingMessage.md#setmaxlisteners-1)
...
**Only valid for response obtained from [ClientRequest](node_http_.ClientRequest.md).**
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_http_.IncomingMessage.md#defaultmaxlisteners).
...
Calling [read](node_http_.IncomingMessage.md#read) after the `'end'` event has
...
using the [pipe](node_http_.IncomingMessage.md#pipe) method.
...
Unlike [push](node_http_.IncomingMessage.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_http_.IncomingMessage.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_http_.IncomingMessage.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](node_http_.IncomingMessage.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
