[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / DiffieHellman

# Class: DiffieHellman

["crypto"](../modules/crypto_.md).DiffieHellman

The `DiffieHellman` class is a utility for creating Diffie-Hellman key
exchanges.

Instances of the `DiffieHellman` class can be created using the [createDiffieHellman](../modules/crypto_.md#creatediffiehellman) function.
...
- [constructor](crypto_.DiffieHellman.md#constructor)

### Properties

- [verifyError](crypto_.DiffieHellman.md#verifyerror)

### Methods

- [computeSecret](crypto_.DiffieHellman.md#computesecret)
- [generateKeys](crypto_.DiffieHellman.md#generatekeys)
- [getGenerator](crypto_.DiffieHellman.md#getgenerator)
- [getPrime](crypto_.DiffieHellman.md#getprime)
- [getPrivateKey](crypto_.DiffieHellman.md#getprivatekey)
- [getPublicKey](crypto_.DiffieHellman.md#getpublickey)
- [setPrivateKey](crypto_.DiffieHellman.md#setprivatekey)
- [setPublicKey](crypto_.DiffieHellman.md#setpublickey)
