[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](../modules/stream_.md) / Duplex

# Class: Duplex

["stream"](../modules/stream_.md).Duplex
...
- [`Readable`](stream_.Readable.md)
  ...
  ↳↳ [`Transform`](node_stream_.Transform.md)
...
- [constructor](stream_.Duplex.md#constructor)

### Properties

- [allowHalfOpen](stream_.Duplex.md#allowhalfopen)
- [destroyed](stream_.Duplex.md#destroyed)
- [locked](stream_.Duplex.md#locked)
- [readable](stream_.Duplex.md#readable)
- [readableAborted](stream_.Duplex.md#readableaborted)
- [readableEncoding](stream_.Duplex.md#readableencoding)
- [readableEnded](stream_.Duplex.md#readableended)
- [readableFlowing](stream_.Duplex.md#readableflowing)
- [readableHighWaterMark](stream_.Duplex.md#readablehighwatermark)
- [readableLength](stream_.Duplex.md#readablelength)
- [readableObjectMode](stream_.Duplex.md#readableobjectmode)
- [writable](stream_.Duplex.md#writable)
- [writableCorked](stream_.Duplex.md#writablecorked)
- [writableEnded](stream_.Duplex.md#writableended)
- [writableFinished](stream_.Duplex.md#writablefinished)
- [writableHighWaterMark](stream_.Duplex.md#writablehighwatermark)
- [writableLength](stream_.Duplex.md#writablelength)
- [writableObjectMode](stream_.Duplex.md#writableobjectmode)
- [captureRejectionSymbol](stream_.Duplex.md#capturerejectionsymbol)
- [captureRejections](stream_.Duplex.md#capturerejections)
- [defaultMaxListeners](stream_.Duplex.md#defaultmaxlisteners)
- [errorMonitor](stream_.Duplex.md#errormonitor)

### Methods

- [[asyncIterator]](stream_.Duplex.md#[asynciterator])
- [\_construct](stream_.Duplex.md#_construct)
- [\_destroy](stream_.Duplex.md#_destroy)
- [\_final](stream_.Duplex.md#_final)
- [\_read](stream_.Duplex.md#_read)
- [\_write](stream_.Duplex.md#_write)
- [\_writev](stream_.Duplex.md#_writev)
- [abort](stream_.Duplex.md#abort)
- [addListener](stream_.Duplex.md#addlistener)
- [cancel](stream_.Duplex.md#cancel)
- [close](stream_.Duplex.md#close)
- [cork](stream_.Duplex.md#cork)
- [destroy](stream_.Duplex.md#destroy)
- [emit](stream_.Duplex.md#emit)
- [end](stream_.Duplex.md#end)
- [eventNames](stream_.Duplex.md#eventnames)
- [forEach](stream_.Duplex.md#foreach)
- [getMaxListeners](stream_.Duplex.md#getmaxlisteners)
- [getReader](stream_.Duplex.md#getreader)
- [getWriter](stream_.Duplex.md#getwriter)
- [isPaused](stream_.Duplex.md#ispaused)
- [listenerCount](stream_.Duplex.md#listenercount)
- [listeners](stream_.Duplex.md#listeners)
- [off](stream_.Duplex.md#off)
- [on](stream_.Duplex.md#on)
- [once](stream_.Duplex.md#once)
- [pause](stream_.Duplex.md#pause)
- [pipe](stream_.Duplex.md#pipe)
- [pipeThrough](stream_.Duplex.md#pipethrough)
- [pipeTo](stream_.Duplex.md#pipeto)
- [prependListener](stream_.Duplex.md#prependlistener)
- [prependOnceListener](stream_.Duplex.md#prependoncelistener)
- [push](stream_.Duplex.md#push)
- [rawListeners](stream_.Duplex.md#rawlisteners)
- [read](stream_.Duplex.md#read)
- [removeAllListeners](stream_.Duplex.md#removealllisteners)
- [removeListener](stream_.Duplex.md#removelistener)
- [resume](stream_.Duplex.md#resume)
- [setDefaultEncoding](stream_.Duplex.md#setdefaultencoding)
- [setEncoding](stream_.Duplex.md#setencoding)
- [setMaxListeners](stream_.Duplex.md#setmaxlisteners)
- [tee](stream_.Duplex.md#tee)
- [uncork](stream_.Duplex.md#uncork)
- [unpipe](stream_.Duplex.md#unpipe)
- [unshift](stream_.Duplex.md#unshift)
- [wrap](stream_.Duplex.md#wrap)
- [write](stream_.Duplex.md#write)
- [from](stream_.Duplex.md#from)
- [getEventListeners](stream_.Duplex.md#geteventlisteners)
- [isDisturbed](stream_.Duplex.md#isdisturbed)
- [listenerCount](stream_.Duplex.md#listenercount-1)
- [on](stream_.Duplex.md#on-1)
- [once](stream_.Duplex.md#once-1)
- [setMaxListeners](stream_.Duplex.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](stream_.Duplex.md#uncork) or [end](stream_.Duplex.md#end) methods are called.
...
Calling the [write](stream_.Duplex.md#write) method after calling [end](stream_.Duplex.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream_.Duplex.md#defaultmaxlisteners).
...
Calling [read](stream_.Duplex.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](stream_.Duplex.md#cork) was called.
...
using the [pipe](stream_.Duplex.md#pipe) method.
...
Unlike [push](stream_.Duplex.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream_.Duplex.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream_.Duplex.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream_.Duplex.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream_.Duplex.md#pipe). However, if calling `write()` is preferred, it is
