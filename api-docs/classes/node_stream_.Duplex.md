[bun-types](../README.md) / [Exports](../modules.md) / ["node:stream"](../modules/node_stream_.md) / Duplex

# Class: Duplex

["node:stream"](../modules/node_stream_.md).Duplex
...
- [constructor](node_stream_.Duplex.md#constructor)

### Properties

- [allowHalfOpen](node_stream_.Duplex.md#allowhalfopen)
- [destroyed](node_stream_.Duplex.md#destroyed)
- [locked](node_stream_.Duplex.md#locked)
- [readable](node_stream_.Duplex.md#readable)
- [readableAborted](node_stream_.Duplex.md#readableaborted)
- [readableEncoding](node_stream_.Duplex.md#readableencoding)
- [readableEnded](node_stream_.Duplex.md#readableended)
- [readableFlowing](node_stream_.Duplex.md#readableflowing)
- [readableHighWaterMark](node_stream_.Duplex.md#readablehighwatermark)
- [readableLength](node_stream_.Duplex.md#readablelength)
- [readableObjectMode](node_stream_.Duplex.md#readableobjectmode)
- [writable](node_stream_.Duplex.md#writable)
- [writableCorked](node_stream_.Duplex.md#writablecorked)
- [writableEnded](node_stream_.Duplex.md#writableended)
- [writableFinished](node_stream_.Duplex.md#writablefinished)
- [writableHighWaterMark](node_stream_.Duplex.md#writablehighwatermark)
- [writableLength](node_stream_.Duplex.md#writablelength)
- [writableObjectMode](node_stream_.Duplex.md#writableobjectmode)
- [captureRejectionSymbol](node_stream_.Duplex.md#capturerejectionsymbol)
- [captureRejections](node_stream_.Duplex.md#capturerejections)
- [defaultMaxListeners](node_stream_.Duplex.md#defaultmaxlisteners)
- [errorMonitor](node_stream_.Duplex.md#errormonitor)

### Methods

- [[asyncIterator]](node_stream_.Duplex.md#[asynciterator])
- [\_construct](node_stream_.Duplex.md#_construct)
- [\_destroy](node_stream_.Duplex.md#_destroy)
- [\_final](node_stream_.Duplex.md#_final)
- [\_read](node_stream_.Duplex.md#_read)
- [\_write](node_stream_.Duplex.md#_write)
- [\_writev](node_stream_.Duplex.md#_writev)
- [abort](node_stream_.Duplex.md#abort)
- [addListener](node_stream_.Duplex.md#addlistener)
- [cancel](node_stream_.Duplex.md#cancel)
- [close](node_stream_.Duplex.md#close)
- [cork](node_stream_.Duplex.md#cork)
- [destroy](node_stream_.Duplex.md#destroy)
- [emit](node_stream_.Duplex.md#emit)
- [end](node_stream_.Duplex.md#end)
- [eventNames](node_stream_.Duplex.md#eventnames)
- [forEach](node_stream_.Duplex.md#foreach)
- [getMaxListeners](node_stream_.Duplex.md#getmaxlisteners)
- [getReader](node_stream_.Duplex.md#getreader)
- [getWriter](node_stream_.Duplex.md#getwriter)
- [isPaused](node_stream_.Duplex.md#ispaused)
- [listenerCount](node_stream_.Duplex.md#listenercount)
- [listeners](node_stream_.Duplex.md#listeners)
- [off](node_stream_.Duplex.md#off)
- [on](node_stream_.Duplex.md#on)
- [once](node_stream_.Duplex.md#once)
- [pause](node_stream_.Duplex.md#pause)
- [pipe](node_stream_.Duplex.md#pipe)
- [pipeThrough](node_stream_.Duplex.md#pipethrough)
- [pipeTo](node_stream_.Duplex.md#pipeto)
- [prependListener](node_stream_.Duplex.md#prependlistener)
- [prependOnceListener](node_stream_.Duplex.md#prependoncelistener)
- [push](node_stream_.Duplex.md#push)
- [rawListeners](node_stream_.Duplex.md#rawlisteners)
- [read](node_stream_.Duplex.md#read)
- [removeAllListeners](node_stream_.Duplex.md#removealllisteners)
- [removeListener](node_stream_.Duplex.md#removelistener)
- [resume](node_stream_.Duplex.md#resume)
- [setDefaultEncoding](node_stream_.Duplex.md#setdefaultencoding)
- [setEncoding](node_stream_.Duplex.md#setencoding)
- [setMaxListeners](node_stream_.Duplex.md#setmaxlisteners)
- [tee](node_stream_.Duplex.md#tee)
- [uncork](node_stream_.Duplex.md#uncork)
- [unpipe](node_stream_.Duplex.md#unpipe)
- [unshift](node_stream_.Duplex.md#unshift)
- [wrap](node_stream_.Duplex.md#wrap)
- [write](node_stream_.Duplex.md#write)
- [from](node_stream_.Duplex.md#from)
- [getEventListeners](node_stream_.Duplex.md#geteventlisteners)
- [isDisturbed](node_stream_.Duplex.md#isdisturbed)
- [listenerCount](node_stream_.Duplex.md#listenercount-1)
- [on](node_stream_.Duplex.md#on-1)
- [once](node_stream_.Duplex.md#once-1)
- [setMaxListeners](node_stream_.Duplex.md#setmaxlisteners-1)
...
| Name | Type |
| :------ | :------ |
| `opts?` | [`DuplexOptions`](../interfaces/stream_.DuplexOptions.md) |
...
[stream.d.ts:864](https://github.com/valgaze/bun-types/blob/5e53f27/stream.d.ts#L864)
...
[Writable](stream_.Writable.md).[writableEnded](stream_.Writable.md#writableended)
...
[Writable](stream_.Writable.md).[abort](stream_.Writable.md#abort)
...
▸ **addListener**(`event`, `listener`): [`Duplex`](stream_.Duplex.md)
...
The buffered data will be flushed when either the [uncork](node_stream_.Duplex.md#uncork) or [end](node_stream_.Duplex.md#end) methods are called.
...
▸ **destroy**(`error?`): [`Duplex`](stream_.Duplex.md)
...
▸ **end**(`cb?`): [`Duplex`](stream_.Duplex.md)
...
Calling the [write](node_stream_.Duplex.md#write) method after calling [end](node_stream_.Duplex.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`Duplex`](stream_.Duplex.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`Duplex`](stream_.Duplex.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_stream_.Duplex.md#defaultmaxlisteners).
...
[Writable](stream_.Writable.md).[getMaxListeners](stream_.Writable.md#getmaxlisteners)
...
▸ **off**(`eventName`, `listener`): [`Duplex`](stream_.Duplex.md)
...
▸ **on**(`event`, `listener`): [`Duplex`](stream_.Duplex.md)
...
▸ **once**(`event`, `listener`): [`Duplex`](stream_.Duplex.md)
...
▸ **pause**(): [`Duplex`](stream_.Duplex.md)
...
▸ **prependListener**(`event`, `listener`): [`Duplex`](stream_.Duplex.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`Duplex`](stream_.Duplex.md)
...
Calling [read](node_stream_.Duplex.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`Duplex`](stream_.Duplex.md)
...
▸ **removeListener**(`event`, `listener`): [`Duplex`](stream_.Duplex.md)
...
▸ **resume**(): [`Duplex`](stream_.Duplex.md)
...
▸ **setDefaultEncoding**(`encoding`): [`Duplex`](stream_.Duplex.md)
...
▸ **setEncoding**(`encoding`): [`Duplex`](stream_.Duplex.md)
...
▸ **setMaxListeners**(`n`): [`Duplex`](stream_.Duplex.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_stream_.Duplex.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`Duplex`](stream_.Duplex.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_stream_.Duplex.md#pipe) method.
...
Unlike [push](node_stream_.Duplex.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_stream_.Duplex.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_stream_.Duplex.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`Duplex`](stream_.Duplex.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_stream_.Duplex.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_stream_.Duplex.md#pipe). However, if calling `write()` is preferred, it is
