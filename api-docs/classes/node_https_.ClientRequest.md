[bun-types](../README.md) / [Exports](../modules.md) / ["node:https"](../modules/node_https_.md) / ClientRequest

# Class: ClientRequest

["node:https"](../modules/node_https_.md).ClientRequest

This object is created internally and returned from [request](../modules/node_https_.md#request). It
...
argument which is an instance of [IncomingMessage](node_https_.IncomingMessage.md).
...
- [constructor](node_https_.ClientRequest.md#constructor)

### Properties

- [aborted](node_https_.ClientRequest.md#aborted)
- [host](node_https_.ClientRequest.md#host)
- [maxHeadersCount](node_https_.ClientRequest.md#maxheaderscount)
- [method](node_https_.ClientRequest.md#method)
- [path](node_https_.ClientRequest.md#path)
- [protocol](node_https_.ClientRequest.md#protocol)
- [reusedSocket](node_https_.ClientRequest.md#reusedsocket)

### Methods

- [abort](node_https_.ClientRequest.md#abort)
- [addListener](node_https_.ClientRequest.md#addlistener)
- [flushHeaders](node_https_.ClientRequest.md#flushheaders)
- [getHeader](node_https_.ClientRequest.md#getheader)
- [getRawHeaderNames](node_https_.ClientRequest.md#getrawheadernames)
- [on](node_https_.ClientRequest.md#on)
- [once](node_https_.ClientRequest.md#once)
- [prependListener](node_https_.ClientRequest.md#prependlistener)
- [prependOnceListener](node_https_.ClientRequest.md#prependoncelistener)
- [removeHeader](node_https_.ClientRequest.md#removeheader)
- [setHeader](node_https_.ClientRequest.md#setheader)
- [setNoDelay](node_https_.ClientRequest.md#setnodelay)
- [setSocketKeepAlive](node_https_.ClientRequest.md#setsocketkeepalive)
- [setTimeout](node_https_.ClientRequest.md#settimeout)
...
[http.d.ts:234](https://github.com/valgaze/bun-types/blob/5e53f27/http.d.ts#L234)
...
[http.d.ts:339](https://github.com/valgaze/bun-types/blob/5e53f27/http.d.ts#L339)
...
[http.d.ts:381](https://github.com/valgaze/bun-types/blob/5e53f27/http.d.ts#L381)
...
[http.d.ts:399](https://github.com/valgaze/bun-types/blob/5e53f27/http.d.ts#L399)
...
[http.d.ts:426](https://github.com/valgaze/bun-types/blob/5e53f27/http.d.ts#L426)
