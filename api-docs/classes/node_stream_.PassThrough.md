[bun-types](../README.md) / [Exports](../modules.md) / ["node:stream"](../modules/node_stream_.md) / PassThrough

# Class: PassThrough

["node:stream"](../modules/node_stream_.md).PassThrough
...
- [constructor](node_stream_.PassThrough.md#constructor)

### Properties

- [allowHalfOpen](node_stream_.PassThrough.md#allowhalfopen)
- [destroyed](node_stream_.PassThrough.md#destroyed)
- [locked](node_stream_.PassThrough.md#locked)
- [readable](node_stream_.PassThrough.md#readable)
- [readableAborted](node_stream_.PassThrough.md#readableaborted)
- [readableEncoding](node_stream_.PassThrough.md#readableencoding)
- [readableEnded](node_stream_.PassThrough.md#readableended)
- [readableFlowing](node_stream_.PassThrough.md#readableflowing)
- [readableHighWaterMark](node_stream_.PassThrough.md#readablehighwatermark)
- [readableLength](node_stream_.PassThrough.md#readablelength)
- [readableObjectMode](node_stream_.PassThrough.md#readableobjectmode)
- [writable](node_stream_.PassThrough.md#writable)
- [writableCorked](node_stream_.PassThrough.md#writablecorked)
- [writableEnded](node_stream_.PassThrough.md#writableended)
- [writableFinished](node_stream_.PassThrough.md#writablefinished)
- [writableHighWaterMark](node_stream_.PassThrough.md#writablehighwatermark)
- [writableLength](node_stream_.PassThrough.md#writablelength)
- [writableObjectMode](node_stream_.PassThrough.md#writableobjectmode)
- [captureRejectionSymbol](node_stream_.PassThrough.md#capturerejectionsymbol)
- [captureRejections](node_stream_.PassThrough.md#capturerejections)
- [defaultMaxListeners](node_stream_.PassThrough.md#defaultmaxlisteners)
- [errorMonitor](node_stream_.PassThrough.md#errormonitor)

### Methods

- [[asyncIterator]](node_stream_.PassThrough.md#[asynciterator])
- [\_construct](node_stream_.PassThrough.md#_construct)
- [\_destroy](node_stream_.PassThrough.md#_destroy)
- [\_final](node_stream_.PassThrough.md#_final)
- [\_flush](node_stream_.PassThrough.md#_flush)
- [\_read](node_stream_.PassThrough.md#_read)
- [\_transform](node_stream_.PassThrough.md#_transform)
- [\_write](node_stream_.PassThrough.md#_write)
- [\_writev](node_stream_.PassThrough.md#_writev)
- [abort](node_stream_.PassThrough.md#abort)
- [addListener](node_stream_.PassThrough.md#addlistener)
- [cancel](node_stream_.PassThrough.md#cancel)
- [close](node_stream_.PassThrough.md#close)
- [cork](node_stream_.PassThrough.md#cork)
- [destroy](node_stream_.PassThrough.md#destroy)
- [emit](node_stream_.PassThrough.md#emit)
- [end](node_stream_.PassThrough.md#end)
- [eventNames](node_stream_.PassThrough.md#eventnames)
- [forEach](node_stream_.PassThrough.md#foreach)
- [getMaxListeners](node_stream_.PassThrough.md#getmaxlisteners)
- [getReader](node_stream_.PassThrough.md#getreader)
- [getWriter](node_stream_.PassThrough.md#getwriter)
- [isPaused](node_stream_.PassThrough.md#ispaused)
- [listenerCount](node_stream_.PassThrough.md#listenercount)
- [listeners](node_stream_.PassThrough.md#listeners)
- [off](node_stream_.PassThrough.md#off)
- [on](node_stream_.PassThrough.md#on)
- [once](node_stream_.PassThrough.md#once)
- [pause](node_stream_.PassThrough.md#pause)
- [pipe](node_stream_.PassThrough.md#pipe)
- [pipeThrough](node_stream_.PassThrough.md#pipethrough)
- [pipeTo](node_stream_.PassThrough.md#pipeto)
- [prependListener](node_stream_.PassThrough.md#prependlistener)
- [prependOnceListener](node_stream_.PassThrough.md#prependoncelistener)
- [push](node_stream_.PassThrough.md#push)
- [rawListeners](node_stream_.PassThrough.md#rawlisteners)
- [read](node_stream_.PassThrough.md#read)
- [removeAllListeners](node_stream_.PassThrough.md#removealllisteners)
- [removeListener](node_stream_.PassThrough.md#removelistener)
- [resume](node_stream_.PassThrough.md#resume)
- [setDefaultEncoding](node_stream_.PassThrough.md#setdefaultencoding)
- [setEncoding](node_stream_.PassThrough.md#setencoding)
- [setMaxListeners](node_stream_.PassThrough.md#setmaxlisteners)
- [tee](node_stream_.PassThrough.md#tee)
- [uncork](node_stream_.PassThrough.md#uncork)
- [unpipe](node_stream_.PassThrough.md#unpipe)
- [unshift](node_stream_.PassThrough.md#unshift)
- [wrap](node_stream_.PassThrough.md#wrap)
- [write](node_stream_.PassThrough.md#write)
- [from](node_stream_.PassThrough.md#from)
- [getEventListeners](node_stream_.PassThrough.md#geteventlisteners)
- [isDisturbed](node_stream_.PassThrough.md#isdisturbed)
- [listenerCount](node_stream_.PassThrough.md#listenercount-1)
- [on](node_stream_.PassThrough.md#on-1)
- [once](node_stream_.PassThrough.md#once-1)
- [setMaxListeners](node_stream_.PassThrough.md#setmaxlisteners-1)
...
▸ **addListener**(`event`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
The buffered data will be flushed when either the [uncork](node_stream_.PassThrough.md#uncork) or [end](node_stream_.PassThrough.md#end) methods are called.
...
▸ **destroy**(`error?`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **end**(`cb?`): [`PassThrough`](stream_.PassThrough.md)
...
Calling the [write](node_stream_.PassThrough.md#write) method after calling [end](node_stream_.PassThrough.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`PassThrough`](stream_.PassThrough.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_stream_.PassThrough.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **on**(`event`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **once**(`event`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **pause**(): [`PassThrough`](stream_.PassThrough.md)
...
▸ **prependListener**(`event`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
Calling [read](node_stream_.PassThrough.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **removeListener**(`event`, `listener`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **resume**(): [`PassThrough`](stream_.PassThrough.md)
...
▸ **setDefaultEncoding**(`encoding`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **setEncoding**(`encoding`): [`PassThrough`](stream_.PassThrough.md)
...
▸ **setMaxListeners**(`n`): [`PassThrough`](stream_.PassThrough.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_stream_.PassThrough.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`PassThrough`](stream_.PassThrough.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](node_stream_.PassThrough.md#pipe) method.
...
Unlike [push](node_stream_.PassThrough.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](node_stream_.PassThrough.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](node_stream_.PassThrough.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`PassThrough`](stream_.PassThrough.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](node_stream_.PassThrough.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_stream_.PassThrough.md#pipe). However, if calling `write()` is preferred, it is
