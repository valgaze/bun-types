[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](../modules/stream_.md) / Readable

# Class: Readable<R\>

["stream"](../modules/stream_.md).Readable
...
- [`Stream`](stream_.Stream.md)
  ...
  ↳↳ [`IncomingMessage`](node_http_.IncomingMessage.md)

  ↳↳ [`IncomingMessage`](https_.IncomingMessage.md)

  ↳↳ [`IncomingMessage`](node_https_.IncomingMessage.md)

  ↳↳ [`Duplex`](stream_.Duplex.md)

  ↳↳ [`Duplex`](node_stream_.Duplex.md)
...
- [constructor](stream_.Readable.md#constructor)

### Properties

- [destroyed](stream_.Readable.md#destroyed)
- [locked](stream_.Readable.md#locked)
- [readable](stream_.Readable.md#readable)
- [readableAborted](stream_.Readable.md#readableaborted)
- [readableEncoding](stream_.Readable.md#readableencoding)
- [readableEnded](stream_.Readable.md#readableended)
- [readableFlowing](stream_.Readable.md#readableflowing)
- [readableHighWaterMark](stream_.Readable.md#readablehighwatermark)
- [readableLength](stream_.Readable.md#readablelength)
- [readableObjectMode](stream_.Readable.md#readableobjectmode)
- [captureRejectionSymbol](stream_.Readable.md#capturerejectionsymbol)
- [captureRejections](stream_.Readable.md#capturerejections)
- [defaultMaxListeners](stream_.Readable.md#defaultmaxlisteners)
- [errorMonitor](stream_.Readable.md#errormonitor)

### Methods

- [[asyncIterator]](stream_.Readable.md#[asynciterator])
- [\_construct](stream_.Readable.md#_construct)
- [\_destroy](stream_.Readable.md#_destroy)
- [\_read](stream_.Readable.md#_read)
- [addListener](stream_.Readable.md#addlistener)
- [cancel](stream_.Readable.md#cancel)
- [destroy](stream_.Readable.md#destroy)
- [emit](stream_.Readable.md#emit)
- [eventNames](stream_.Readable.md#eventnames)
- [forEach](stream_.Readable.md#foreach)
- [getMaxListeners](stream_.Readable.md#getmaxlisteners)
- [getReader](stream_.Readable.md#getreader)
- [isPaused](stream_.Readable.md#ispaused)
- [listenerCount](stream_.Readable.md#listenercount)
- [listeners](stream_.Readable.md#listeners)
- [off](stream_.Readable.md#off)
- [on](stream_.Readable.md#on)
- [once](stream_.Readable.md#once)
- [pause](stream_.Readable.md#pause)
- [pipe](stream_.Readable.md#pipe)
- [pipeThrough](stream_.Readable.md#pipethrough)
- [pipeTo](stream_.Readable.md#pipeto)
- [prependListener](stream_.Readable.md#prependlistener)
- [prependOnceListener](stream_.Readable.md#prependoncelistener)
- [push](stream_.Readable.md#push)
- [rawListeners](stream_.Readable.md#rawlisteners)
- [read](stream_.Readable.md#read)
- [removeAllListeners](stream_.Readable.md#removealllisteners)
- [removeListener](stream_.Readable.md#removelistener)
- [resume](stream_.Readable.md#resume)
- [setEncoding](stream_.Readable.md#setencoding)
- [setMaxListeners](stream_.Readable.md#setmaxlisteners)
- [tee](stream_.Readable.md#tee)
- [unpipe](stream_.Readable.md#unpipe)
- [unshift](stream_.Readable.md#unshift)
- [wrap](stream_.Readable.md#wrap)
- [from](stream_.Readable.md#from)
- [getEventListeners](stream_.Readable.md#geteventlisteners)
- [isDisturbed](stream_.Readable.md#isdisturbed)
- [listenerCount](stream_.Readable.md#listenercount-1)
- [on](stream_.Readable.md#on-1)
- [once](stream_.Readable.md#once-1)
- [setMaxListeners](stream_.Readable.md#setmaxlisteners-1)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream_.Readable.md#defaultmaxlisteners).
...
Calling [read](stream_.Readable.md#read) after the `'end'` event has
...
using the [pipe](stream_.Readable.md#pipe) method.
...
Unlike [push](stream_.Readable.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream_.Readable.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream_.Readable.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream_.Readable.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
