[bun-types](../README.md) / [Exports](../modules.md) / ["node:http"](../modules/node_http_.md) / ClientRequest

# Class: ClientRequest

["node:http"](../modules/node_http_.md).ClientRequest

This object is created internally and returned from [request](../modules/node_http_.md#request). It
...
argument which is an instance of [IncomingMessage](node_http_.IncomingMessage.md).
...
- [constructor](node_http_.ClientRequest.md#constructor)

### Properties

- [aborted](node_http_.ClientRequest.md#aborted)
- [host](node_http_.ClientRequest.md#host)
- [maxHeadersCount](node_http_.ClientRequest.md#maxheaderscount)
- [method](node_http_.ClientRequest.md#method)
- [path](node_http_.ClientRequest.md#path)
- [protocol](node_http_.ClientRequest.md#protocol)
- [reusedSocket](node_http_.ClientRequest.md#reusedsocket)

### Methods

- [abort](node_http_.ClientRequest.md#abort)
- [addListener](node_http_.ClientRequest.md#addlistener)
- [flushHeaders](node_http_.ClientRequest.md#flushheaders)
- [getHeader](node_http_.ClientRequest.md#getheader)
- [getRawHeaderNames](node_http_.ClientRequest.md#getrawheadernames)
- [on](node_http_.ClientRequest.md#on)
- [once](node_http_.ClientRequest.md#once)
- [prependListener](node_http_.ClientRequest.md#prependlistener)
- [prependOnceListener](node_http_.ClientRequest.md#prependoncelistener)
- [removeHeader](node_http_.ClientRequest.md#removeheader)
- [setHeader](node_http_.ClientRequest.md#setheader)
- [setNoDelay](node_http_.ClientRequest.md#setnodelay)
- [setSocketKeepAlive](node_http_.ClientRequest.md#setsocketkeepalive)
- [setTimeout](node_http_.ClientRequest.md#settimeout)
