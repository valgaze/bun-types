[bun-types](../README.md) / [Exports](../modules.md) / ["events"](../modules/events_.md) / EventEmitter

# Class: EventEmitter

["events"](../modules/events_.md).EventEmitter
...
- **`EventEmitter`**
  ...
  ↳ [`Domain`](node_domain_.Domain.md)

## Table of contents

### Constructors

- [constructor](events_.EventEmitter-1.md#constructor)

### Properties

- [captureRejectionSymbol](events_.EventEmitter-1.md#capturerejectionsymbol)
- [captureRejections](events_.EventEmitter-1.md#capturerejections)
- [defaultMaxListeners](events_.EventEmitter-1.md#defaultmaxlisteners)
- [errorMonitor](events_.EventEmitter-1.md#errormonitor)

### Methods

- [addListener](events_.EventEmitter-1.md#addlistener)
- [emit](events_.EventEmitter-1.md#emit)
- [eventNames](events_.EventEmitter-1.md#eventnames)
- [getMaxListeners](events_.EventEmitter-1.md#getmaxlisteners)
- [listenerCount](events_.EventEmitter-1.md#listenercount)
- [listeners](events_.EventEmitter-1.md#listeners)
- [off](events_.EventEmitter-1.md#off)
- [on](events_.EventEmitter-1.md#on)
- [once](events_.EventEmitter-1.md#once)
- [prependListener](events_.EventEmitter-1.md#prependlistener)
- [prependOnceListener](events_.EventEmitter-1.md#prependoncelistener)
- [rawListeners](events_.EventEmitter-1.md#rawlisteners)
- [removeAllListeners](events_.EventEmitter-1.md#removealllisteners)
- [removeListener](events_.EventEmitter-1.md#removelistener)
- [setMaxListeners](events_.EventEmitter-1.md#setmaxlisteners)
- [getEventListeners](events_.EventEmitter-1.md#geteventlisteners)
- [listenerCount](events_.EventEmitter-1.md#listenercount-1)
- [on](events_.EventEmitter-1.md#on-1)
- [once](events_.EventEmitter-1.md#once-1)
- [setMaxListeners](events_.EventEmitter-1.md#setmaxlisteners-1)
...
▸ **addListener**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](events_.EventEmitter-1.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **on**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **once**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **prependListener**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **removeAllListeners**(`event?`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **removeListener**(`eventName`, `listener`): [`EventEmitter`](events_.EventEmitter-1.md)
...
▸ **setMaxListeners**(`n`): [`EventEmitter`](events_.EventEmitter-1.md)
