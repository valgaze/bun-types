[bun-types](../README.md) / [Exports](../modules.md) / ["node:crypto"](../modules/node_crypto_.md) / Sign

# Class: Sign

["node:crypto"](../modules/node_crypto_.md).Sign
...
The [createSign](../modules/node_crypto_.md#createsign) method is used to create `Sign` instances. The
...
- [constructor](node_crypto_.Sign.md#constructor)

### Properties

- [destroyed](node_crypto_.Sign.md#destroyed)
- [locked](node_crypto_.Sign.md#locked)
- [writable](node_crypto_.Sign.md#writable)
- [writableCorked](node_crypto_.Sign.md#writablecorked)
- [writableEnded](node_crypto_.Sign.md#writableended)
- [writableFinished](node_crypto_.Sign.md#writablefinished)
- [writableHighWaterMark](node_crypto_.Sign.md#writablehighwatermark)
- [writableLength](node_crypto_.Sign.md#writablelength)
- [writableObjectMode](node_crypto_.Sign.md#writableobjectmode)
- [captureRejectionSymbol](node_crypto_.Sign.md#capturerejectionsymbol)
- [captureRejections](node_crypto_.Sign.md#capturerejections)
- [defaultMaxListeners](node_crypto_.Sign.md#defaultmaxlisteners)
- [errorMonitor](node_crypto_.Sign.md#errormonitor)

### Methods

- [\_construct](node_crypto_.Sign.md#_construct)
- [\_destroy](node_crypto_.Sign.md#_destroy)
- [\_final](node_crypto_.Sign.md#_final)
- [\_write](node_crypto_.Sign.md#_write)
- [\_writev](node_crypto_.Sign.md#_writev)
- [abort](node_crypto_.Sign.md#abort)
- [addListener](node_crypto_.Sign.md#addlistener)
- [close](node_crypto_.Sign.md#close)
- [cork](node_crypto_.Sign.md#cork)
- [destroy](node_crypto_.Sign.md#destroy)
- [emit](node_crypto_.Sign.md#emit)
- [end](node_crypto_.Sign.md#end)
- [eventNames](node_crypto_.Sign.md#eventnames)
- [getMaxListeners](node_crypto_.Sign.md#getmaxlisteners)
- [getWriter](node_crypto_.Sign.md#getwriter)
- [listenerCount](node_crypto_.Sign.md#listenercount)
- [listeners](node_crypto_.Sign.md#listeners)
- [off](node_crypto_.Sign.md#off)
- [on](node_crypto_.Sign.md#on)
- [once](node_crypto_.Sign.md#once)
- [pipe](node_crypto_.Sign.md#pipe)
- [prependListener](node_crypto_.Sign.md#prependlistener)
- [prependOnceListener](node_crypto_.Sign.md#prependoncelistener)
- [rawListeners](node_crypto_.Sign.md#rawlisteners)
- [removeAllListeners](node_crypto_.Sign.md#removealllisteners)
- [removeListener](node_crypto_.Sign.md#removelistener)
- [setDefaultEncoding](node_crypto_.Sign.md#setdefaultencoding)
- [setMaxListeners](node_crypto_.Sign.md#setmaxlisteners)
- [sign](node_crypto_.Sign.md#sign)
- [uncork](node_crypto_.Sign.md#uncork)
- [update](node_crypto_.Sign.md#update)
- [write](node_crypto_.Sign.md#write)
- [getEventListeners](node_crypto_.Sign.md#geteventlisteners)
- [listenerCount](node_crypto_.Sign.md#listenercount-1)
- [on](node_crypto_.Sign.md#on-1)
- [once](node_crypto_.Sign.md#once-1)
- [setMaxListeners](node_crypto_.Sign.md#setmaxlisteners-1)
...
[crypto.d.ts:1434](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L1434)
...
▸ **addListener**(`event`, `listener`): [`Sign`](crypto_.Sign.md)
...
The buffered data will be flushed when either the [uncork](node_crypto_.Sign.md#uncork) or [end](node_crypto_.Sign.md#end) methods are called.
...
▸ **destroy**(`error?`): [`Sign`](crypto_.Sign.md)
...
Calling the [write](node_crypto_.Sign.md#write) method after calling [end](node_crypto_.Sign.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`Sign`](crypto_.Sign.md)
...
▸ **end**(`chunk`, `encoding`, `cb?`): [`Sign`](crypto_.Sign.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](node_crypto_.Sign.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`Sign`](crypto_.Sign.md)
...
▸ **on**(`event`, `listener`): [`Sign`](crypto_.Sign.md)
...
▸ **once**(`event`, `listener`): [`Sign`](crypto_.Sign.md)
...
▸ **prependListener**(`event`, `listener`): [`Sign`](crypto_.Sign.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`Sign`](crypto_.Sign.md)
...
▸ **removeAllListeners**(`event?`): [`Sign`](crypto_.Sign.md)
...
▸ **removeListener**(`event`, `listener`): [`Sign`](crypto_.Sign.md)
...
▸ **setDefaultEncoding**(`encoding`): [`Sign`](crypto_.Sign.md)
...
▸ **setMaxListeners**(`n`): [`Sign`](crypto_.Sign.md)
...
▸ **sign**(`privateKey`): [`Buffer`](../modules/buffer_.md#buffer)

Calculates the signature on all the data passed through using either `sign.update()` or `sign.write()`.

If `privateKey` is not a `KeyObject`, this function behaves as if`privateKey` had been passed to [createPrivateKey](../modules/node_crypto_.md#createprivatekey). If it is an
...
| Name | Type |
| :------ | :------ |
| `privateKey` | [`KeyLike`](../modules/crypto_.md#keylike) \| [`SignKeyObjectInput`](../interfaces/crypto_.SignKeyObjectInput.md) \| [`SignPrivateKeyInput`](../interfaces/crypto_.SignPrivateKeyInput.md) |
...
[crypto.d.ts:1457](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L1457)
...
| :------ | :------ |
| `privateKey` | [`KeyLike`](../modules/crypto_.md#keylike) \| [`SignKeyObjectInput`](../interfaces/crypto_.SignKeyObjectInput.md) \| [`SignPrivateKeyInput`](../interfaces/crypto_.SignPrivateKeyInput.md) |
| `outputFormat` | [`BinaryToTextEncoding`](../modules/crypto_.md#binarytotextencoding) |
...
[crypto.d.ts:1460](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L1460)
...
The `writable.uncork()` method flushes all data buffered since [cork](node_crypto_.Sign.md#cork) was called.
...
▸ **update**(`data`): [`Sign`](crypto_.Sign.md)
...
[crypto.d.ts:1444](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L1444)

▸ **update**(`data`, `inputEncoding`): [`Sign`](crypto_.Sign.md)
...
[crypto.d.ts:1445](https://github.com/valgaze/bun-types/blob/5e53f27/crypto.d.ts#L1445)
...
recommended to encapsulate the logic into a `Readable` and use [pipe](node_crypto_.Sign.md#pipe). However, if calling `write()` is preferred, it is
