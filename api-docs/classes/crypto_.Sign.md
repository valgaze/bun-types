[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / Sign

# Class: Sign

["crypto"](../modules/crypto_.md).Sign
...
The [createSign](../modules/crypto_.md#createsign) method is used to create `Sign` instances. The
...
- [constructor](crypto_.Sign.md#constructor)

### Properties

- [destroyed](crypto_.Sign.md#destroyed)
- [locked](crypto_.Sign.md#locked)
- [writable](crypto_.Sign.md#writable)
- [writableCorked](crypto_.Sign.md#writablecorked)
- [writableEnded](crypto_.Sign.md#writableended)
- [writableFinished](crypto_.Sign.md#writablefinished)
- [writableHighWaterMark](crypto_.Sign.md#writablehighwatermark)
- [writableLength](crypto_.Sign.md#writablelength)
- [writableObjectMode](crypto_.Sign.md#writableobjectmode)
- [captureRejectionSymbol](crypto_.Sign.md#capturerejectionsymbol)
- [captureRejections](crypto_.Sign.md#capturerejections)
- [defaultMaxListeners](crypto_.Sign.md#defaultmaxlisteners)
- [errorMonitor](crypto_.Sign.md#errormonitor)

### Methods

- [\_construct](crypto_.Sign.md#_construct)
- [\_destroy](crypto_.Sign.md#_destroy)
- [\_final](crypto_.Sign.md#_final)
- [\_write](crypto_.Sign.md#_write)
- [\_writev](crypto_.Sign.md#_writev)
- [abort](crypto_.Sign.md#abort)
- [addListener](crypto_.Sign.md#addlistener)
- [close](crypto_.Sign.md#close)
- [cork](crypto_.Sign.md#cork)
- [destroy](crypto_.Sign.md#destroy)
- [emit](crypto_.Sign.md#emit)
- [end](crypto_.Sign.md#end)
- [eventNames](crypto_.Sign.md#eventnames)
- [getMaxListeners](crypto_.Sign.md#getmaxlisteners)
- [getWriter](crypto_.Sign.md#getwriter)
- [listenerCount](crypto_.Sign.md#listenercount)
- [listeners](crypto_.Sign.md#listeners)
- [off](crypto_.Sign.md#off)
- [on](crypto_.Sign.md#on)
- [once](crypto_.Sign.md#once)
- [pipe](crypto_.Sign.md#pipe)
- [prependListener](crypto_.Sign.md#prependlistener)
- [prependOnceListener](crypto_.Sign.md#prependoncelistener)
- [rawListeners](crypto_.Sign.md#rawlisteners)
- [removeAllListeners](crypto_.Sign.md#removealllisteners)
- [removeListener](crypto_.Sign.md#removelistener)
- [setDefaultEncoding](crypto_.Sign.md#setdefaultencoding)
- [setMaxListeners](crypto_.Sign.md#setmaxlisteners)
- [sign](crypto_.Sign.md#sign)
- [uncork](crypto_.Sign.md#uncork)
- [update](crypto_.Sign.md#update)
- [write](crypto_.Sign.md#write)
- [getEventListeners](crypto_.Sign.md#geteventlisteners)
- [listenerCount](crypto_.Sign.md#listenercount-1)
- [on](crypto_.Sign.md#on-1)
- [once](crypto_.Sign.md#once-1)
- [setMaxListeners](crypto_.Sign.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto_.Sign.md#uncork) or [end](crypto_.Sign.md#end) methods are called.
...
Calling the [write](crypto_.Sign.md#write) method after calling [end](crypto_.Sign.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto_.Sign.md#defaultmaxlisteners).
...
If `privateKey` is not a `KeyObject`, this function behaves as if`privateKey` had been passed to [createPrivateKey](../modules/crypto_.md#createprivatekey). If it is an
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.Sign.md#cork) was called.
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.Sign.md#pipe). However, if calling `write()` is preferred, it is
