[bun-types](../README.md) / [Exports](../modules.md) / ["crypto"](../modules/crypto_.md) / Cipher

# Class: Cipher

["crypto"](../modules/crypto_.md).Cipher
...
- [constructor](crypto_.Cipher.md#constructor)

### Properties

- [allowHalfOpen](crypto_.Cipher.md#allowhalfopen)
- [destroyed](crypto_.Cipher.md#destroyed)
- [locked](crypto_.Cipher.md#locked)
- [readable](crypto_.Cipher.md#readable)
- [readableAborted](crypto_.Cipher.md#readableaborted)
- [readableEncoding](crypto_.Cipher.md#readableencoding)
- [readableEnded](crypto_.Cipher.md#readableended)
- [readableFlowing](crypto_.Cipher.md#readableflowing)
- [readableHighWaterMark](crypto_.Cipher.md#readablehighwatermark)
- [readableLength](crypto_.Cipher.md#readablelength)
- [readableObjectMode](crypto_.Cipher.md#readableobjectmode)
- [writable](crypto_.Cipher.md#writable)
- [writableCorked](crypto_.Cipher.md#writablecorked)
- [writableEnded](crypto_.Cipher.md#writableended)
- [writableFinished](crypto_.Cipher.md#writablefinished)
- [writableHighWaterMark](crypto_.Cipher.md#writablehighwatermark)
- [writableLength](crypto_.Cipher.md#writablelength)
- [writableObjectMode](crypto_.Cipher.md#writableobjectmode)
- [captureRejectionSymbol](crypto_.Cipher.md#capturerejectionsymbol)
- [captureRejections](crypto_.Cipher.md#capturerejections)
- [defaultMaxListeners](crypto_.Cipher.md#defaultmaxlisteners)
- [errorMonitor](crypto_.Cipher.md#errormonitor)

### Methods

- [[asyncIterator]](crypto_.Cipher.md#[asynciterator])
- [\_construct](crypto_.Cipher.md#_construct)
- [\_destroy](crypto_.Cipher.md#_destroy)
- [\_final](crypto_.Cipher.md#_final)
- [\_flush](crypto_.Cipher.md#_flush)
- [\_read](crypto_.Cipher.md#_read)
- [\_transform](crypto_.Cipher.md#_transform)
- [\_write](crypto_.Cipher.md#_write)
- [\_writev](crypto_.Cipher.md#_writev)
- [abort](crypto_.Cipher.md#abort)
- [addListener](crypto_.Cipher.md#addlistener)
- [cancel](crypto_.Cipher.md#cancel)
- [close](crypto_.Cipher.md#close)
- [cork](crypto_.Cipher.md#cork)
- [destroy](crypto_.Cipher.md#destroy)
- [emit](crypto_.Cipher.md#emit)
- [end](crypto_.Cipher.md#end)
- [eventNames](crypto_.Cipher.md#eventnames)
- [final](crypto_.Cipher.md#final)
- [forEach](crypto_.Cipher.md#foreach)
- [getMaxListeners](crypto_.Cipher.md#getmaxlisteners)
- [getReader](crypto_.Cipher.md#getreader)
- [getWriter](crypto_.Cipher.md#getwriter)
- [isPaused](crypto_.Cipher.md#ispaused)
- [listenerCount](crypto_.Cipher.md#listenercount)
- [listeners](crypto_.Cipher.md#listeners)
- [off](crypto_.Cipher.md#off)
- [on](crypto_.Cipher.md#on)
- [once](crypto_.Cipher.md#once)
- [pause](crypto_.Cipher.md#pause)
- [pipe](crypto_.Cipher.md#pipe)
- [pipeThrough](crypto_.Cipher.md#pipethrough)
- [pipeTo](crypto_.Cipher.md#pipeto)
- [prependListener](crypto_.Cipher.md#prependlistener)
- [prependOnceListener](crypto_.Cipher.md#prependoncelistener)
- [push](crypto_.Cipher.md#push)
- [rawListeners](crypto_.Cipher.md#rawlisteners)
- [read](crypto_.Cipher.md#read)
- [removeAllListeners](crypto_.Cipher.md#removealllisteners)
- [removeListener](crypto_.Cipher.md#removelistener)
- [resume](crypto_.Cipher.md#resume)
- [setAutoPadding](crypto_.Cipher.md#setautopadding)
- [setDefaultEncoding](crypto_.Cipher.md#setdefaultencoding)
- [setEncoding](crypto_.Cipher.md#setencoding)
- [setMaxListeners](crypto_.Cipher.md#setmaxlisteners)
- [tee](crypto_.Cipher.md#tee)
- [uncork](crypto_.Cipher.md#uncork)
- [unpipe](crypto_.Cipher.md#unpipe)
- [unshift](crypto_.Cipher.md#unshift)
- [update](crypto_.Cipher.md#update)
- [wrap](crypto_.Cipher.md#wrap)
- [write](crypto_.Cipher.md#write)
- [from](crypto_.Cipher.md#from)
- [getEventListeners](crypto_.Cipher.md#geteventlisteners)
- [isDisturbed](crypto_.Cipher.md#isdisturbed)
- [listenerCount](crypto_.Cipher.md#listenercount-1)
- [on](crypto_.Cipher.md#on-1)
- [once](crypto_.Cipher.md#once-1)
- [setMaxListeners](crypto_.Cipher.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto_.Cipher.md#uncork) or [end](crypto_.Cipher.md#end) methods are called.
...
Calling the [write](crypto_.Cipher.md#write) method after calling [end](crypto_.Cipher.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto_.Cipher.md#defaultmaxlisteners).
...
Calling [read](crypto_.Cipher.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto_.Cipher.md#cork) was called.
...
using the [pipe](crypto_.Cipher.md#pipe) method.
...
Unlike [push](crypto_.Cipher.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto_.Cipher.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto_.Cipher.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto_.Cipher.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto_.Cipher.md#pipe). However, if calling `write()` is preferred, it is
