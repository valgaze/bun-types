[bun-types](../README.md) / [Exports](../modules.md) / ["stream"](../modules/stream_.md) / Transform

# Class: Transform

["stream"](../modules/stream_.md).Transform
...
- [`Duplex`](stream_.Duplex.md)
  ...
  ↳↳ [`Hash`](crypto_.Hash.md)

  ↳↳ [`Hmac`](crypto_.Hmac.md)

  ↳↳ [`Cipher`](crypto_.Cipher.md)

  ↳↳ [`Decipher`](crypto_.Decipher.md)

  ↳↳ [`Hash`](node_crypto_.Hash.md)

  ↳↳ [`Hmac`](node_crypto_.Hmac.md)

  ↳↳ [`Cipher`](node_crypto_.Cipher.md)

  ↳↳ [`Decipher`](node_crypto_.Decipher.md)

  ↳↳ [`PassThrough`](stream_.PassThrough.md)

  ↳↳ [`PassThrough`](node_stream_.PassThrough.md)
...
- [constructor](stream_.Transform.md#constructor)

### Properties

- [allowHalfOpen](stream_.Transform.md#allowhalfopen)
- [destroyed](stream_.Transform.md#destroyed)
- [locked](stream_.Transform.md#locked)
- [readable](stream_.Transform.md#readable)
- [readableAborted](stream_.Transform.md#readableaborted)
- [readableEncoding](stream_.Transform.md#readableencoding)
- [readableEnded](stream_.Transform.md#readableended)
- [readableFlowing](stream_.Transform.md#readableflowing)
- [readableHighWaterMark](stream_.Transform.md#readablehighwatermark)
- [readableLength](stream_.Transform.md#readablelength)
- [readableObjectMode](stream_.Transform.md#readableobjectmode)
- [writable](stream_.Transform.md#writable)
- [writableCorked](stream_.Transform.md#writablecorked)
- [writableEnded](stream_.Transform.md#writableended)
- [writableFinished](stream_.Transform.md#writablefinished)
- [writableHighWaterMark](stream_.Transform.md#writablehighwatermark)
- [writableLength](stream_.Transform.md#writablelength)
- [writableObjectMode](stream_.Transform.md#writableobjectmode)
- [captureRejectionSymbol](stream_.Transform.md#capturerejectionsymbol)
- [captureRejections](stream_.Transform.md#capturerejections)
- [defaultMaxListeners](stream_.Transform.md#defaultmaxlisteners)
- [errorMonitor](stream_.Transform.md#errormonitor)

### Methods

- [[asyncIterator]](stream_.Transform.md#[asynciterator])
- [\_construct](stream_.Transform.md#_construct)
- [\_destroy](stream_.Transform.md#_destroy)
- [\_final](stream_.Transform.md#_final)
- [\_flush](stream_.Transform.md#_flush)
- [\_read](stream_.Transform.md#_read)
- [\_transform](stream_.Transform.md#_transform)
- [\_write](stream_.Transform.md#_write)
- [\_writev](stream_.Transform.md#_writev)
- [abort](stream_.Transform.md#abort)
- [addListener](stream_.Transform.md#addlistener)
- [cancel](stream_.Transform.md#cancel)
- [close](stream_.Transform.md#close)
- [cork](stream_.Transform.md#cork)
- [destroy](stream_.Transform.md#destroy)
- [emit](stream_.Transform.md#emit)
- [end](stream_.Transform.md#end)
- [eventNames](stream_.Transform.md#eventnames)
- [forEach](stream_.Transform.md#foreach)
- [getMaxListeners](stream_.Transform.md#getmaxlisteners)
- [getReader](stream_.Transform.md#getreader)
- [getWriter](stream_.Transform.md#getwriter)
- [isPaused](stream_.Transform.md#ispaused)
- [listenerCount](stream_.Transform.md#listenercount)
- [listeners](stream_.Transform.md#listeners)
- [off](stream_.Transform.md#off)
- [on](stream_.Transform.md#on)
- [once](stream_.Transform.md#once)
- [pause](stream_.Transform.md#pause)
- [pipe](stream_.Transform.md#pipe)
- [pipeThrough](stream_.Transform.md#pipethrough)
- [pipeTo](stream_.Transform.md#pipeto)
- [prependListener](stream_.Transform.md#prependlistener)
- [prependOnceListener](stream_.Transform.md#prependoncelistener)
- [push](stream_.Transform.md#push)
- [rawListeners](stream_.Transform.md#rawlisteners)
- [read](stream_.Transform.md#read)
- [removeAllListeners](stream_.Transform.md#removealllisteners)
- [removeListener](stream_.Transform.md#removelistener)
- [resume](stream_.Transform.md#resume)
- [setDefaultEncoding](stream_.Transform.md#setdefaultencoding)
- [setEncoding](stream_.Transform.md#setencoding)
- [setMaxListeners](stream_.Transform.md#setmaxlisteners)
- [tee](stream_.Transform.md#tee)
- [uncork](stream_.Transform.md#uncork)
- [unpipe](stream_.Transform.md#unpipe)
- [unshift](stream_.Transform.md#unshift)
- [wrap](stream_.Transform.md#wrap)
- [write](stream_.Transform.md#write)
- [from](stream_.Transform.md#from)
- [getEventListeners](stream_.Transform.md#geteventlisteners)
- [isDisturbed](stream_.Transform.md#isdisturbed)
- [listenerCount](stream_.Transform.md#listenercount-1)
- [on](stream_.Transform.md#on-1)
- [once](stream_.Transform.md#once-1)
- [setMaxListeners](stream_.Transform.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](stream_.Transform.md#uncork) or [end](stream_.Transform.md#end) methods are called.
...
Calling the [write](stream_.Transform.md#write) method after calling [end](stream_.Transform.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream_.Transform.md#defaultmaxlisteners).
...
Calling [read](stream_.Transform.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](stream_.Transform.md#cork) was called.
...
using the [pipe](stream_.Transform.md#pipe) method.
...
Unlike [push](stream_.Transform.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream_.Transform.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream_.Transform.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream_.Transform.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream_.Transform.md#pipe). However, if calling `write()` is preferred, it is
